                ...
                <div className="col-lg-3 col-md-6 col-sm-12 col-xs-12">
                  <div className="crumina-module crumina-counter-item">
                    ...
                    <p className="counter-text">
                      Lorem ipsum dolor sit, amet consectetur adipisicing elit. Laudantium sit nam eveniet atque,
                      officia, voluptatibus non quo cum minima dicta maiores totam qui tempora temporibus? Ea corporis
                      ipsum magnam placeat.
                    </p>
