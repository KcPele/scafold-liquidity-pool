  ...
  return (
    ...
    (a.prototype = {
      ...
      requestTick: function () {
        this.ticking ||
          (requestAnimationFrame(this.rafCallback || (this.rafCallback = this.update.bind(this))), (this.ticking = !0));
      },
    ...
    (o.fn.headroom = function (e) {
      return this.each(function () {
        ...
        (a = o.extend(!0, {}, Headroom.options, a)),
          n || ((n = new Headroom(this, a)), n.init(), t.data("headroom", n)),
          "string" == typeof e && (n[e](), "destroy" === e && t.removeData("headroom"));
      });
    });
