...
(function (P, J) {
  "object" === typeof module && module.exports
    ? (module.exports = P.document ? J(P) : J)
  ...
  (function (a) {
    ...
    a.Fx.prototype = {
      dSetter: function () {
        ...
        if (1 === u) f = this.toD;
          ...
          for (; C--; ) (r = parseFloat(a[C])), (f[C] = isNaN(r) ? l[C] : u * parseFloat(l[C] - r) + r);
        else f = l;
      ...
      run: function (q, l, f) {
        ...
        q !== l || this.elem["forceAnimate:" + this.prop]
          ? ((this.startTime = +new Date()),
            ...
            (r.elem = this.elem),
            (r.prop = this.prop),
            r() && 1 === a.timers.push(r) && y(p))
          : (delete C.curAnim[this.prop], C.complete && 0 === a.keys(C.curAnim).length && C.complete.call(this.elem));
      },
      step: function (q) {
        var l = +new Date(),
          f,
        ...
        C.attr && !C.element
          ...
          ? ((this.now = this.end),
            ...
            f && r && r.call(C),
            (q = !1))
          : ((this.pos = u.easing((l - this.startTime) / y)),
      ...
      initPath: function (q, l, f) {
        ...
        function C(a, b) {
          for (; a.length < m; ) {
            ...
            x && ((d = a.slice(a.length - g)), [].splice.apply(a, [a.length, 0].concat(d)), c--);
          }
          a[0] = "M";
        }

        function r(a, c) {
          for (var d = (m - a.length) / g; 0 < d && d--; )
            (b = a.slice().splice(a.length / B - g, g * B)),
              (b[0] = c[m - g - d * g]),
              e && ((b[g - 6] = b[g - 2]), (b[g - 5] = b[g - 1])),
      ...
      var q,
        ...
        C = function (f, y) {
          ...
          a.objectEach(y, function (p, d) {
            !a.isObject(p, !0) || a.isClass(p) || a.isDOMElement(p) ? (f[d] = y[d]) : (f[d] = C(f[d] || {}, p));
          });
          return f;
        };
    ...
    a.attr = function (q, l, f) {
      ...
      a.isString(l)
        ? a.defined(f)
          ? q.setAttribute(l, f)
          : q && q.getAttribute && ((u = q.getAttribute(l)) || "class" !== l || (u = q.getAttribute(l + "Name")))
        : a.defined(l) &&
          a.isObject(l) &&
    ...
    a.pick = function () {
      var a = arguments,
        ...
        f,
        u = a.length;
      for (l = 0; l < u; l++) if (((f = a[l]), void 0 !== f && null !== f)) return f;
    };
    a.css = function (q, l) {
    ...
    a.formatSingle = function (q, l, f) {
      ...
      /f$/.test(q)
        ? ((f = (f = q.match(u)) ? f[1] : -1),
          null !== l && (l = a.numberFormat(l, f, C.decimalPoint, -1 < q.indexOf(",") ? C.thousandsSep : "")))
        : (l = (f || a.time).dateFormat(q, l));
      return l;
    };
    a.format = function (q, l, f) {
      for (var u = "{", C = !1, r, y, p, d, e = [], g; q; ) {
        u = q.indexOf(u);
        if (-1 === u) break;
        r = q.slice(0, u);
        if (C) {
    ...
    a.normalizeTickInterval = function (q, l, f, u, C) {
      ...
      r = q / f;
      l ||
        ((l = C ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10]),
        !1 === u &&
          (1 === f
      ...
      for (
        u = 0;
        u < l.length && !((y = l[u]), (C && y * f >= q) || (!C && r <= (l[u] + (l[u + 1] || l[u])) / 2));
        u++
      );
      return (y = a.correctFloat(y * f, -Math.round(Math.log(0.001) / Math.LN10)));
    };
    ...
    a.numberFormat = function (q, l, f, u) {
      ...
      -1 === l
        ...
        ? l &&
          ...
          ((y = l + +d[1]),
          0 <= y
            ? ((d[0] = (+d[0]).toExponential(y).split("e")[0]), (l = y))
            : ((d[0] = d[0].split(".")[0] || 0), (q = 20 > l ? (d[0] * Math.pow(10, d[1])).toFixed(l) : 0), (d[1] = 0)))
        : (l = 2);
      p = (Math.abs(d[1] ? d[0] : q) + Math.pow(10, -Math.max(l, r) - 1)).toFixed(l);
      r = String(a.pInt(p));
    ...
    a.getStyle = function (q, l, f) {
      if ("width" === l)
        return Math.max(
          0,
          Math.min(q.offsetWidth, q.scrollWidth) - a.getStyle(q, "padding-left") - a.getStyle(q, "padding-right"),
        );
      if ("height" === l)
        return Math.max(
          0,
          Math.min(q.offsetHeight, q.scrollHeight) - a.getStyle(q, "padding-top") - a.getStyle(q, "padding-bottom"),
        );
      G.getComputedStyle || a.error(27, !0);
      if ((q = G.getComputedStyle(q, void 0)))
        (q = q.getPropertyValue(l)), a.pick(f, "opacity" !== l) && (q = a.pInt(q));
      return q;
    };
    ...
    a.find = Array.prototype.find
      ...
      : function (a, l) {
          var f,
            u = a.length;
          for (f = 0; f < u; f++) if (l(a[f], f)) return a[f];
        };
    ...
    a.stop = function (q, l) {
      for (var f = a.timers.length; f--; )
        a.timers[f].elem !== q || (l && l !== a.timers[f].prop) || (a.timers[f].stopped = !0);
    };
    ...
    a.addEvent = function (q, l, f, u) {
      var C,
        r = q.addEventListener || a.addEventListenerPolyfill;
      C =
        "function" === typeof q && q.prototype
          ? (q.prototype.protoEvents = q.prototype.protoEvents || {})
    ...
    a.removeEvent = function (q, l, f) {
      ...
      function C(p) {
        ...
        q.nodeName &&
          ...
          a.objectEach(d, function (a, d) {
            if (p[d]) for (e = p[d].length; e--; ) u(d, p[d][e]);
          }));
      }
      var r, y;
      a.each(["protoEvents", "hcEvents"], function (p) {
        ...
        d &&
          (l
            ? ((r = d[l] || []),
              f ? ((y = a.inArray(f, r)), -1 < y && (r.splice(y, 1), (d[l] = r)), u(l, f)) : (C(d), (d[l] = [])))
            : (C(d), (q[p] = {})));
      });
    };
    a.fireEvent = function (q, l, f, u) {
      var C, r, y, p, d;
      f = f || {};
      F.createEvent && (q.dispatchEvent || q.fireEvent)
        ? ((C = F.createEvent("Events")),
          C.initEvent(l, !0, !0),
          a.extend(C, f),
          q.dispatchEvent ? q.dispatchEvent(C) : q.fireEvent(l, C))
        : a.each(["protoEvents", "hcEvents"], function (e) {
            if (q[e])
              for (
                ...
                (d = r[p]) && !1 === d.call(q, f) && f.preventDefault();
          });
    ...
    a.animate = function (q, l, f) {
      ...
      a.objectEach(l, function (d, e) {
        ...
        r = null;
        "d" === e
          ? ((y.paths = y.initPath(q, q.d, l.d)), (y.toD = l.d), (u = 0), (r = 1))
          : q.attr
          ? (u = q.attr(e))
          : ((u = parseFloat(a.getStyle(q, e)) || 0), "opacity" !== e && (C = "px"));
        r || (r = d);
    ...
    a.Color.prototype = {
      ...
      init: function (f) {
        ...
        if ((this.input = f = this.names[f && f.toLowerCase ? f.toLowerCase() : ""] || f) && f.stops)
          this.stops = G(f.stops, function (p) {
      ...
      tweenTo: function (a, l) {
        ...
        r.length && f && f.length
          ? ((a = 1 !== r[3] || 1 !== f[3]),
            (l =
              (a ? "rgba(" : "rgb(") +
              Math.round(r[0] + (f[0] - r[0]) * (1 - l)) +
              "," +
              Math.round(r[1] + (f[1] - r[1]) * (1 - l)) +
              "," +
              Math.round(r[2] + (f[2] - r[2]) * (1 - l)) +
              (a ? "," + (r[3] + (f[3] - r[3]) * (1 - l)) : "") +
              ")"))
          : (l = a.input || "none");
        return l;
  ...
  (function (a) {
    ...
    m(E.prototype, {
      ...
      init: function (a, b) {
        this.element = "span" === b ? r(b) : e.createElementNS(this.SVG_NS, b);
        this.renderer = a;
      },
      animate: function (b, k, c) {
        k = a.animObject(w(k, this.renderer.globalAnimation, !0));
        0 !== k.duration
          ? (c && (k.complete = c), q(this, b, k))
          : (this.attr(b, null, c), k.step && k.step.call(this));
        return this;
      },
          ...
          function () {
            ...
            d &&
              ...
              K[D]
                ? (z = K[D].attr("id"))
                : ((h.id = z = a.uniqueKey()),
                  (K[D] = w = M.createElement(d).attr(h).add(M.defs)),
                  (w.radAttr = m),
                  (w.stops = []),
                  g(e, function (b) {
                    0 === b[1].indexOf("rgba")
                      ? ((A = a.color(b[1])), (x = A.get("rgb")), (n = A.get("a")))
                      : ((x = b[1]), (n = 1));
                    b = M.createElement("stop")
                      .attr({
                        offset: b[0],
                        "stop-color": x,
                        "stop-opacity": n,
      ...
      applyTextOutline: function (k) {
        var c = this.element,
          ...
          h,
          m;
        -1 !== k.indexOf("contrast") && (k = k.replace(/contrast/g, this.renderer.getContrast(c.style.fill)));
        k = k.split(" ");
        A = k[k.length - 1];
        if ((d = k[0]) && "none" !== d && a.svg) {
          ...
          d = d.replace(/(^[\d\.]+)(.*?)$/g, function (a, b, k) {
            return 2 * b + k;
          });
          for (m = k.length; m--; )
            (M = k[m]), "highcharts-text-outline" === M.getAttribute("class") && b(k, c.removeChild(M));
          h = c.firstChild;
          g(k, function (a, b) {
            0 === b &&
      ...
      attr: function (a, b, k, c) {
        ...
        "string" === typeof a
          ? (h = (this[a + "Getter"] || this._defaultGetter).call(this, a, A))
          : (v(
              a,
              function (b, k) {
                m = !1;
                c || Q(this, k);
                this.symbolName &&
                  /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)$/.test(k) &&
                  (d || (this.symbolAttr(a), (d = !0)), (m = !0));
                !this.rotation || ("x" !== k && "y" !== k) || (this.doTransform = !0);
                m ||
                  ((K = this[k + "Setter"] || this._defaultSetter),
                  K.call(this, b, k, A),
                  this.shadows &&
                    /^(width|height|visibility|x|y|d|transform|cx|cy|r)$/.test(k) &&
                    this.updateShadows(k, b, K));
              },
              this,
            ),
            this.afterSetters());
      ...
      updateShadows: function (a, b, k) {
        for (var c = this.shadows, M = c.length; M--; )
          k.call(c[M], "height" === a ? Math.max(b - (c[M].cutHeight || 0), 0) : "d" === a ? this.d : b, a, c[M]);
      },
      addClass: function (a, b) {
        var k = this.attr("class") || "";
        -1 === k.indexOf(a) && (b || (a = (k + (k ? " " : "") + a).replace("  ", " ")), this.attr("class", a));
        return this;
      },
      hasClass: function (a) {
        ...
        K &&
          ...
          a &&
            (null === a.width || "auto" === a.width
              ...
              : "text" === A.nodeName.toLowerCase() && a.width && (d = this.textWidth = k(a.width))),
          (this.styles = a),
          d && !T && this.renderer.forExport && delete a.width,
          A.namespaceURI === this.SVG_NS
            ? ((h = function (a, b) {
        ...
        x && "click" === a
          ? ((c.ontouchstart = function (a) {
            ...
            (c.onclick = function (a) {
              (-1 === N.navigator.userAgent.indexOf("Android") || 1100 < Date.now() - (k.touchEventFired || 0)) &&
                b.call(c, a);
            }))
          : (c["on" + a] = b);
        return this;
          ...
          : d &&
            a.push(
              "rotate(" +
                d +
                " " +
                w(this.rotationOriginX, m.getAttribute("x"), 0) +
                " " +
                w(this.rotationOriginY, m.getAttribute("y") || 0) +
                ")",
            );
      ...
      align: function (a, k, c) {
        ...
        var K, v;
        if (a) {
          if (((this.alignOptions = a), (this.alignByTranslate = k), !c || D(c)))
            (this.alignTo = A = c || "renderer"), b(h, this), h.push(this), (c = null);
      ...
      getBBox: function (a, b) {
        ...
        y(K) &&
          ((n = K.toString()),
          -1 === n.indexOf("\x3c") && (n = n.replace(/[0-9]/g, "0")),
          (n += ["", b || 0, M, this.textWidth, h && h.textOverflow].join()));
        n && !a && (k = e[n]);
        if (!k) {
          if (d.namespaceURI === this.SVG_NS || c.forExport) {
            try {
              (v =
                this.fakeTS &&
                function (a) {
          ...
          c.isSVG &&
            ((a = k.width),
            (c = k.height),
            h && "11px" === h.fontSize && 17 === Math.round(c) && (k.height = c = 14),
            b &&
              ((k.width = Math.abs(c * Math.sin(A)) + Math.abs(a * Math.cos(A))),
              (k.height = Math.abs(c * Math.cos(A)) + Math.abs(a * Math.sin(A)))));
          if (n && 0 < k.height) {
      ...
      destroy: function () {
        ...
        d &&
          A &&
          (g(A.querySelectorAll("[clip-path],[CLIP-PATH]"), function (a) {
        ...
        if (!a) this.destroyShadows();
          ...
          for (A = 1; A <= v; A++)
            (d = h.cloneNode(0)),
              ...
              k && (l(d, "height", Math.max(l(d, "height") - m, 0)), (d.cutHeight = m)),
              b ? b.element.appendChild(d) : h.parentNode && h.parentNode.insertBefore(d, h),
              c.push(d);
          this.shadows = c;
        }
        return this;
      ...
      zIndexSetter: function (a, b) {
        ...
        var w;
        y(a)
          ? (m.setAttribute("data-z-index", a), (a = +a), this[b] === a && (h = !1))
          : y(this[b]) && m.removeAttribute("data-z-index");
        this[b] = a;
        if (h) {
    ...
    E.prototype["stroke-widthSetter"] = E.prototype.strokeSetter = function (a, b, k) {
      ...
      this.stroke && this["stroke-width"]
        ? (E.prototype.fillSetter.call(this, this.stroke, "stroke", k),
          ...
          (this.hasStroke = !0))
        : "stroke-width" === b && 0 === a && this.hasStroke && (k.removeAttribute("stroke"), (this.hasStroke = !1));
    };
    ...
    m(F.prototype, {
      ...
      init: function (a, b, k, c, A, d) {
        ...
        a.appendChild(m);
        l(a, "dir", "ltr");
        -1 === a.innerHTML.indexOf("xmlns") && l(m, "xmlns", this.SVG_NS);
        this.isSVG = !0;
        this.box = m;
        this.boxWrapper = c;
        this.alignedObjects = [];
        this.url =
          (n || h) && e.getElementsByTagName("base").length
            ? N.location.href
                .split("#")[0]
                .replace(/<[^>]*>/g, "")
                .replace(/([\('\)])/g, "\\$1")
        ...
        n &&
          ...
          b(),
          (this.unSubPixelFix = G(N, "resize", b)));
      },
      getStyle: function (a) {
        return (this.style = m(
          {
        ...
        var m = this,
          ...
          z = function (d, v) {
            ...
            if (void 0 === x[v])
              ...
              else B(h(k || c, d)), (x[v] = A + m.getSpanWidth(a, b));
            return x[v];
          },
          t,
          D;
        ...
        var b = a.element,
          ...
          y = function (a, b) {
            v(A.escapes, function (k, c) {
              (b && -1 !== B(k, b)) || (a = a.toString().replace(new RegExp(k, "g"), c));
            });
            return a;
          },
          N = function (a, b) {
            ...
            k = a.indexOf(b + "\x3d");
            if (-1 !== k && ((k = k + b.length + 1), (b = a.charAt(k)), '"' === b || "'" === b))
              return (a = a.substring(k + 1)), a.substring(0, a.indexOf(b));
          };
        ...
        if (O !== a.textCache) {
          ...
          m || Q || p || D || -1 !== h.indexOf(" ")
            ? (t && t.appendChild(b),
              ...
              g(h, function (k, c) {
                ...
                g(h, function (k) {
                  if ("" !== k || 1 === h.length) {
                    ...
                    if ((g = N(k, "style"))) (g = g.replace(/(;| |^)color([ :])/, "$1fill$2")), l(n, "style", g);
                    (t = N(k, "href")) &&
                      !d &&
                      (l(n, "onclick", 'location.href\x3d"' + t + '"'),
                      l(n, "class", "highcharts-anchor"),
                      C(n, {
                        cursor: "pointer",
                      }));
                    ...
                    if (" " !== k) {
                      ...
                      if (D) {
                        ...
                        var H = r(n);
                        if (p)
                          x = A.truncate(a, n, k, void 0, 0, Math.max(0, D - parseInt(M || 12, 10)), function (a, b) {
                          ...
                          for (; B.length; )
                            B.length &&
                              !I &&
                              0 < t &&
                              ((n = e.createElementNS(K, "tspan")),
                              l(n, {
                                dy: H,
                                x: z,
                              }),
                              g && l(n, "style", g),
                              n.appendChild(e.createTextNode(B.join(" ").replace(/- /g, "-"))),
                              b.appendChild(n)),
                              A.truncate(a, n, null, B, 0 === t ? v : 0, D, function (a, b) {
              ...
              p && x && a.attr("title", y(a.textStr, ["\x26lt;", "\x26gt;"])),
              t && t.removeChild(b),
              Q && a.applyTextOutline && a.applyTextOutline(Q))
            : b.appendChild(e.createTextNode(y(h)));
        }
      },
      ...
      button: function (a, b, k, c, A, d, h, v, K) {
        ...
        w.setState = function (a) {
          ...
          w.attr([A, d, h, v][a || 0]).css([n, g, x, t][a || 0]);
        };
        w.attr(A).css(
          m(
            {
      ...
      image: function (a, b, k, c, A, d) {
        ...
        d
          ? (K(v.element, "data:image/gif;base64,R0lGODlhAQABAAAAACH5BAEKAAEALAAAAAABAAEAAAICTAEAOw\x3d\x3d"),
            (h = new N.Image()),
            G(h, "load", w),
            (h.src = a),
            h.complete && w({}))
      ...
      symbol: function (a, b, k, c, A, d) {
        ...
        t
          ...
          : n &&
            ((z = a.match(K)[1]),
            (v = this.image(z)),
            (v.imgwidth = w(O[z] && O[z].width, d && d.width)),
            (v.imgheight = w(O[z] && O[z].height, d && d.height)),
            (D = function () {
              v.attr({
                width: v.width,
                height: v.height,
            ...
            g(["width", "height"], function (a) {
              v[a + "Setter"] = function (a, b) {
                ...
                this[b] = a;
                y(c) &&
                  (this.element && this.element.setAttribute(b, c),
                  this.alignByTranslate || ((k[A] = ((this[b] || 0) - c) / 2), this.attr(k)));
              };
            }),
            y(b) &&
              v.attr({
      ...
      symbols: {
        ...
        arc: function (a, b, k, c, A) {
          var d = A.start,
            ...
            m = A.end - 0.001;
          k = A.innerR;
          c = w(A.open, 0.001 > Math.abs(A.end - A.start - 2 * Math.PI));
          var K = Math.cos(d),
            e = Math.sin(d),
            n = Math.cos(m),
            m = Math.sin(m);
          A = 0.001 > A.end - d - Math.PI ? 0 : 1;
        ...
        callout: function (a, b, k, c, A) {
          ...
          v && v > k
            ? A > b + h && A < b + c - h
              ? m.splice(13, 3, "L", a + k, A - 6, a + k + 6, A, a + k, A + 6, a + k, b + c - d)
              : m.splice(13, 3, "L", a + k, c / 2, v, A, a + k, c / 2, a + k, b + c - d)
            : v && 0 > v
            ? A > b + h && A < b + c - h
              ? m.splice(33, 3, "L", a, A + 6, a - 6, A, a, A - 6, a, b + d)
              : m.splice(33, 3, "L", a, c / 2, v, A, a, c / 2, a, b + d)
            : A && A > c && v > a + h && v < a + k - h
            ? m.splice(23, 3, "L", v + 6, b + c, v, b + c + 6, v - 6, b + c, a + d, b + c)
            : A && 0 > A && v > a + h && v < a + k - h && m.splice(3, 3, "L", v - 6, b, v, b - 6, v + 6, b, k - d, b);
          return m;
        },
      },
      ...
      label: function (b, k, c, d, h, v, K, w, e) {
        ...
        q = function () {
          ...
          C &&
            (B ||
              ((x.box = B = n.symbols[d] || M ? n.symbol(d) : n.rect()),
              B.addClass(("button" === e ? "" : "highcharts-label-box") + (e ? " highcharts-" + e + "-box" : "")),
              B.add(x),
              (a = u()),
              (b.x = a),
              (b.y = (w ? -N : 0) + a)),
            (b.width = Math.round(x.width)),
            (b.height = Math.round(x.height)),
            B.attr(m(b, r)),
            (r = {}));
        };
        S = function () {
          ...
          y(p) &&
            ...
            (a +=
              ...
              (p - z.width));
          if (a !== t.x || b !== t.y)
            t.attr("x", a), t.hasBoxWidthChanged && ((z = t.getBBox(!0)), q()), void 0 !== b && t.attr("y", b);
          t.x = a;
          t.y = b;
        };
        W = function (a, b) {
  ...
  (function (a) {
          ...
          if ("SPAN" === b.tagName) {
            ...
            (H = h !== this.oldTextWidth) &&
              ...
              ((H = this.textPxLength) ||
                ...
                (H = b.offsetWidth)),
              (H = H > h));
            H && /[ \-]/.test(b.textContent || b.innerText)
              ? (G(b, {
                  width: h + "px",
                  display: "block",
                  whiteSpace: D || "normal",
            ...
            I !== this.cTT &&
              ((D = a.fontMetrics(b.style.fontSize).b),
              !q(z) || (z === (this.oldRotation || 0) && n === this.oldAlign) || this.setSpanRotation(z, g, D),
              this.getSpanCorrection((!q(z) && this.textPxLength) || b.offsetWidth, D, g, z, n));
            G(b, {
    ...
    f(d.prototype, {
      getTransformKey: function () {
        return C && !/Edge/.test(e.navigator.userAgent)
          ? "-ms-transform"
          : r
          ? "-webkit-transform"
          : u
  ...
  (function (a) {
    ...
    a.Time.prototype = {
        ...
        (this.variableTimezone = !(f && !a.getTimezoneOffset && !a.timezone)) || this.timezoneOffset
          ? ((this.get = function (a, d) {
            ...
            (this.set = function (a, d, e) {
              var g;
              if ("Milliseconds" === a || "Seconds" === a || ("Minutes" === a && 0 === d.getTimezoneOffset() % 60))
                d["set" + a](e);
              else
                (g = y.getTimezoneOffset(d)),
                  (g = d.getTime() - g),
                  d.setTime(g),
                  d["setUTC" + a](e),
                  (a = y.getTimezoneOffset(d)),
                  (g = d.getTime() + a),
                  d.setTime(g);
            }))
          : f
      ...
      makeTime: function (f, r, y, p, d, e) {
        var g, m, b;
        this.useUTC
          ? ((g = this.Date.UTC.apply(0, arguments)),
            (m = this.getTimezoneOffset(g)),
            (g += m),
            (b = this.getTimezoneOffset(g)),
            m !== b ? (g += b - m) : m - 36e5 !== this.getTimezoneOffset(g - 36e5) || a.isSafari || (g -= 36e5))
          : (g = new this.Date(f, r, l(y, 1), l(p, 0), l(d, 0), l(e, 0)).getTime());
        return g;
      },
      ...
      getTimeTicks: function (a, r, y, p) {
        ...
        if (E(r)) {
          ...
          c >= f.month &&
            (d.set("Month", g, c >= f.year ? 0 : x * Math.floor(d.get("Month", g) / x)), (b = d.get("FullYear", g)));
            ...
            e.push(r),
              (r =
                c === f.year
                  ...
                  : !B || (c !== f.day && c !== f.week)
                  ? B && c === f.hour && 1 < x
                    ? d.makeTime(b, p, t, n + g * x)
                    : r + c * x
                  : d.makeTime(b, p, t + g * x * (c === f.day ? 1 : 7))),
              g++;
          e.push(r);
          c <= f.hour &&
            1e4 > e.length &&
    ...
    a.Tick.prototype = {
      addLabel: function () {
        ...
        if (F(d))
          ...
          if (
            (this.label = d =
              F(l) && m.enabled ? p.renderer.text(l, 0, 0, m.useHTML).css(f(m.style)).add(a.labelGroup) : null)
          )
      ...
      handleOverflow: function (a) {
        var f = this.axis,
          ...
          z,
          D = {};
        if (c || "justify" !== u(p.overflow, "justify"))
          0 > c && d - x * B < m
            ? (z = Math.round(d / Math.cos(c * C) - m))
            : 0 < c && d + x * B > g && (z = Math.round((e - d) / Math.cos(c * C)));
        else if (
          ((e = d + (1 - x) * B),
          d - x * B < m ? (n = a.x + n * (1 - x) - m) : e > g && ((n = g - a.x + n * x), (l = -1)),
          (n = Math.min(t, n)),
          n < t && "center" === f.labelAlign && (a.x += l * (t - n - x * (t - Math.min(B, n)))),
          B > n || (f.autoRotation && (b.styles || {}).width))
        )
          z = n;
        z && ((D.width = z), (p.style || {}).textOverflow || (D.textOverflow = "ellipsis"), b.css(D));
      },
      getPosition: function (f, l, p, d) {
        ...
        f = {
          x: f
            ? a.correctFloat(e.translate(l + p, null, null, d) + e.transB)
            : e.left + e.offset + (e.opposite ? ((d && g.oldChartWidth) || g.chartWidth) - e.right - e.left : 0),
          y: f
            ? m - e.bottom + e.offset - (e.opposite ? e.height : 0)
            : a.correctFloat(m - e.translate(l + p, null, null, d) - e.transB),
        };
      ...
      getLabelPosition: function (a, f, p, d, e, g, m, b) {
        var c = this.axis,
          ...
          l = e.y,
          z = d || c.reserveSpaceDefault ? 0 : -c.labelOffset * ("center" === c.labelAlign ? 0.5 : 1),
          D = {};
        F(l) ||
          (l =
            0 === c.side
              ...
              : 2 === c.side
              ? n.y + 8
              : Math.cos(p.rotation * C) * (n.y - p.getBBox(!1, 0).height / 2));
      ...
      getMarkPath: function (a, f, p, d, e, g) {
        return g.crispLine(["M", a, f, "L", a + (e ? 0 : -p), f + (e ? p : 0)], d);
      },
        ...
        g ||
          ...
          (this.gridLine = g =
            B.path()
              ...
              .add(d.gridGroup)));
        if (!a && g && (a = d.getPlotLinePath(b + x, g.strokeWidth() * p, a, !0)))
      ...
      renderLabel: function (a, f, p, d) {
        ...
        b &&
          l(t) &&
          ((b.xy = a = this.getLabelPosition(t, a, b, g, c, e, d, x)),
          (this.isFirst && !this.isLast && !u(m.showFirstLabel, 1)) ||
          (this.isLast && !this.isFirst && !u(m.showLastLabel, 1))
            ? (B = !1)
            : !g || c.step || c.rotation || f || 0 === p || this.handleOverflow(a),
          x && d % x && (B = !1),
          B && l(a.y)
            ? ((a.opacity = p), b[this.isNewLabel ? "attr" : "animate"](a), (this.isNewLabel = !1))
            : (b.attr("y", -9999), (this.isNewLabel = !0)));
      },
  ...
  var ea = (function (a) {
    ...
    a.extend(w.prototype, {
      ...
      init: function (a, b) {
        ...
        b = A.options.events;
        -1 === c(A, a.axes) && (k ? a.axes.splice(a.xAxis.length, 0, A) : a.axes.push(A), a[A.coll].push(A));
        A.series = A.series || [];
      ...
      defaultLabelFormatter: function () {
        ...
        if (t) n = g(t, this, d);
          ...
          for (; e-- && void 0 === n; )
            (d = Math.pow(m, e + 1)),
              b >= d && 0 === (10 * c) % d && null !== w[e] && 0 !== c && (n = a.numberFormat(c / d, -1) + w[e]);
              ...
              if (a.isXAxis)
                (A = k.xData),
                  A.length &&
                    ((k = q(A)),
                    (h = G(A)),
                    B(k) || k instanceof Date || ((A = b(A, B)), (k = q(A)), (h = G(A))),
                    A.length &&
                      ((a.dataMin = Math.min(D(a.dataMin, A[0], k), k)),
                      (a.dataMax = Math.max(D(a.dataMax, A[0], h), h))));
              else if (
                (k.getExtremes(),
                (h = k.dataMax),
                (k = k.dataMin),
                C(k) &&
                  C(h) &&
                  ((a.dataMin = Math.min(D(a.dataMin, k), k)), (a.dataMax = Math.max(D(a.dataMax, h), h))),
                C(d) && (a.threshold = d),
                !A.softThreshold || a.positiveValuesOnly)
              )
                a.softThreshold = !1;
            }
          });
      ...
      translate: function (a, b, c, d, h, v) {
        ...
        b
          ? ((a = (a * A + m - n) / w + d), h && (a = k.lin2val(a)))
          : (h && (a = k.val2lin(a)), (a = B(d) ? A * (a - d) * w + m + A * n + (B(v) ? w * v : 0) : void 0));
        return a;
      },
      ...
      getPlotLinePath: function (a, b, c, d, h) {
        var k = this.chart,
          ...
          m,
          w,
          n = (c && k.oldChartHeight) || k.chartHeight,
        ...
        a = c = Math.round(h + m);
        m = w = Math.round(n - h - m);
        B(h)
          ? this.horiz
            ? ((m = v), (w = n - this.bottom), (a = c = t(a, A, A + this.width)))
            : ((a = A), (c = e - this.right), (m = w = t(m, v, v + this.height)))
          : ((K = !0), (d = !1));
        return K && !d ? null : k.renderer.crispLine(["M", a, m, "L", c, w], b || 1);
      },
      getLinearTickPositions: function (a, b, c) {
        var k,
          A = f(Math.floor(b / a) * a);
        c = f(Math.ceil(c / a) * a);
        var d = [],
          h;
        f(A + a) === A && (h = 20);
      ...
      getMinorTickPositions: function () {
        ...
        if (w && w / d < a.len / 3)
          if (a.isLog)
            p(this.paddedTicks, function (b, k, c) {
              k && h.push.apply(h, a.getLogTickPositions(d, c[k - 1], c[k], !0));
            });
          else if (a.isDatetimeAxis && "auto" === this.getMinorTickInterval())
            h = h.concat(a.getTimeTicks(a.normalizeTimeTickInterval(d), m, v, b.startOfWeek));
          else for (b = m + ((c[0] - m) % d); b <= v && b !== h[0]; b += d) h.push(b);
      ...
      adjustForMinRange: function () {
        ...
        c - b < this.minRange &&
          ...
          (d = (t - c + b) / 2),
          (d = [b - d, D(a.min, b - d)]),
          h && (d[2] = this.isLog ? this.log2lin(this.dataMin) : this.dataMin),
          (b = G(d)),
          (c = [b + t, D(a.max, b + t)]),
          h && (c[2] = this.isLog ? this.log2lin(this.dataMax) : this.dataMax),
          (c = q(c)),
          c - b < t && ((d[0] = c - t), (d[1] = D(a.min, c - t)), (b = G(d))));
        this.min = b;
        this.max = c;
      },
      getClosest: function () {
      ...
      nameToX: function (a) {
        ...
        C(d) ||
          (d = !1 === this.options.uniqueNames ? a.series.autoIncrement() : b ? c(a.name, k) : D(k.keys[a.name], -1));
        -1 === d ? b || (h = k.length) : (h = d);
      ...
      setAxisTranslation: function (a) {
        ...
        if (g || w || k)
          (d = b.getClosest()),
            m
              ? ((h = m.minPointOffset), (v = m.pointRangePadding))
              : p(b.series, function (a) {
                  var c = w ? 1 : g ? D(a.options.pointRange, d, 0) : b.axisPointRange || 0;
                  a = a.options.pointPlacement;
                  k = Math.max(k, c);
                  b.single || ((h = Math.max(h, t(a) ? 0 : c / 2)), (v = Math.max(v, "on" === a ? 0 : c)));
                }),
            (m = b.ordinalSlope && d ? b.ordinalSlope / d : 1),
            (b.minPointOffset = h *= m),
            (b.pointRangePadding = v *= m),
            (b.pointRange = Math.min(k, c)),
      ...
      setTickInterval: function (b) {
        ...
        q = D(c.userMax, d.max);
        n
          ? ((c.linkedParent = k[c.coll][d.linkedTo]),
            (k = c.linkedParent.getExtremes()),
            (c.min = D(k.min, k.dataMin)),
            (c.max = D(k.max, k.dataMax)),
            d.type !== c.linkedParent.options.type && a.error(11, 1))
          : (!l && C(I) && (c.dataMin >= I ? ((r = I), (g = 0)) : c.dataMax <= I && ((y = I), (t = 0))),
            (c.min = D(u, r, c.dataMin)),
            (c.max = D(q, y, c.dataMax)));
        h &&
          (c.positiveValuesOnly && !b && 0 >= Math.min(c.min, D(c.dataMin, c.min)) && a.error(10, 1),
          (c.min = f(c.log2lin(c.min), 15)),
          (c.max = f(c.log2lin(c.max), 15)));
        c.range &&
          C(c.max) &&
          ((c.userMin = c.min = u = Math.max(c.dataMin, c.minFromRange())), (c.userMax = q = c.max), (c.range = null));
        e(c, "foundExtremes");
        c.beforePadding && c.beforePadding();
        c.adjustForMinRange();
        !(H || c.axisPointRange || c.usePercentage || n) &&
          C(c.min) &&
          C(c.max) &&
          (k = c.max - c.min) &&
          (!C(u) && g && (c.min -= k * g), !C(q) && t && (c.max += k * t));
        B(d.softMin) && !B(c.userMin) && (c.min = Math.min(c.min, d.softMin));
        B(d.softMax) && !B(c.userMax) && (c.max = Math.max(c.max, d.softMax));
        B(d.floor) && (c.min = Math.max(c.min, d.floor));
        B(d.ceiling) && (c.max = Math.min(c.max, d.ceiling));
        l &&
          C(c.dataMin) &&
          ((I = I || 0),
          !C(u) && c.min < I && c.dataMin >= I ? (c.min = I) : !C(q) && c.max > I && c.dataMax <= I && (c.max = I));
        c.tickInterval =
          c.min === c.max || void 0 === c.min || void 0 === c.max
            ? 1
            : n && !x && z === c.linkedParent.options.tickPixelInterval
            ? (x = c.linkedParent.tickInterval)
            : D(
                x,
                this.tickAmount ? (c.max - c.min) / Math.max(this.tickAmount - 1, 1) : void 0,
                H ? 1 : ((c.max - c.min) * z) / Math.max(c.len, z),
              );
        w &&
          !b &&
          p(c.series, function (a) {
        ...
        v ||
          ...
          (c.tickInterval = L(
            ...
            null,
            m(c.tickInterval),
            D(d.allowDecimals, !(0.5 < c.tickInterval && 5 > c.tickInterval && 1e3 < c.max && 9999 > c.max)),
            !!this.tickAmount,
          ));
      ...
      setTickPositions: function () {
        ...
        !c &&
          (!this.ordinalPositions && (this.max - this.min) / this.tickInterval > Math.max(2 * this.len, 200)
            ? ((c = [this.min, this.max]), a.error(19))
            : (c = this.isDatetimeAxis
                ? this.getTimeTicks(
                    this.normalizeTimeTickInterval(this.tickInterval, b.units),
                    this.min,
                    this.max,
                    b.startOfWeek,
          ...
          h && (h = h.apply(this, [this.min, this.max]))) &&
          (this.tickPositions = c = h);
        this.paddedTicks = c.slice(0);
        this.trimTicks(c, v, m);
        this.isLinked ||
          (this.single && 2 > c.length && ((this.min -= 0.5), (this.max += 0.5)), d || h || this.adjustTickAmount());
      ...
      alignToOthers: function () {
        ...
        !1 === this.chart.options.chart.alignTicks ||
          ...
          !1 === c.endOnTick ||
          this.isLog ||
          p(this.chart[this.coll], function (c) {
            var k = c.options,
      ...
      adjustTickAmount: function () {
        ...
        if (this.hasData()) {
          if (h < c) {
            for (; b.length < c; )
              b.length % 2 || this.min === v ? b.push(f(b[b.length - 1] + a)) : b.unshift(f(b[0] - a));
            this.transA *= (h - 1) / (c - 1);
            this.min = b[0];
      ...
      zoom: function (a, b) {
        ...
        if (a !== this.min || b !== this.max)
          this.allowZoomOutside ||
            (C(c) && (a < h && (a = h), a > d && (a = d)), C(k) && (b < h && (b = h), b > d && (b = d))),
      ...
      unsquish: function () {
        ...
        b
          ? (t = !a.staggerLines && !a.step && (C(m) ? [m] : h < D(a.autoRotationLimit, 80) && a.autoRotation)) &&
            p(t, function (a) {
              var b;
              if (a === m || (a && -90 <= a && 90 >= a))
                (n = g(Math.abs(w.h / Math.sin(r * a)))),
                  (b = n + Math.abs(a / 360)),
                  b < e && ((e = b), (v = a), (d = n));
            })
          : a.step || (d = g(w.h));
      ...
      getSlotWidth: function () {
        var a = this.chart,
          ...
          h = a.margin[3];
        return (
          (b && 2 > (c.step || 0) && !c.rotation && ((this.staggerLines || 1) * this.len) / d) ||
          (!b && ((c.style && parseInt(c.style.width, 10)) || (h && h - a.spacing[3]) || 0.33 * a.chartWidth))
        );
      },
      renderUnsquish: function () {
        var a = this.chart,
          ...
          e = {},
          g = this.labelMetrics(),
          x = h.style && h.style.textOverflow,
          B,
          z,
          D = 0,
          H;
          ...
          for (z = "clip", n = c.length; !m && n--; )
            if (((H = c[n]), (H = d[H].label)))
              H.styles && "ellipsis" === H.styles.textOverflow
                ...
                H.getBBox().height > this.len / c.length - (g.h - g.f) && (H.specificTextOverflow = "ellipsis");
        e.rotation && ((B = D > 0.5 * a.chartHeight ? 0.33 * a.chartHeight : D), x || (z = "ellipsis"));
        ...
        p(c, function (a) {
          ...
          b &&
            (b.attr(e),
            B && !c && "nowrap" !== v.whiteSpace && (B < b.textPxLength || "SPAN" === b.element.tagName)
              ? ((k.width = B), x || (k.textOverflow = b.specificTextOverflow || z), b.css(k))
              : b.styles &&
                b.styles.width &&
                !k.width &&
                !c &&
      ...
      hasData: function () {
        return (
          this.hasVisibleSeries || (C(this.min) && C(this.max) && this.tickPositions && 0 < this.tickPositions.length)
        );
      },
      addTitle: function (a) {
      ...
      getOffset: function () {
        ...
        a.axisGroup ||
          ((a.gridGroup = c
            ...
            .addClass("highcharts-" + this.coll.toLowerCase() + "-grid " + (y || ""))
            .add(u)),
          (a.axisGroup = c
            .g("axis")
            .attr({
          ...
          (a.labelGroup = c
            ...
            .addClass("highcharts-" + a.coll.toLowerCase() + "-labels " + (y || ""))
            .add(u)));
        t || a.isLinked
          ? (p(h, function (b, c) {
              a.generateTick(b, c);
            ...
            D(f.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) &&
              p(h, function (a) {
        ...
        I &&
          ...
          g &&
            !1 !== I.reserveSpace &&
            ((a.titleOffset = x = a.axisTitle.getBBox()[m ? "height" : "width"]),
            (B = I.offset),
            (H = C(B) ? 0 : D(I.margin, m ? 5 : 10))));
        a.renderLine();
      ...
      getLinePath: function (a) {
        ...
        return b.renderer.crispLine(
          [
            ...
            k ? d : this.top,
            "L",
            k ? b.chartWidth - this.right : h,
            k ? d : b.chartHeight - this.bottom,
          ],
          a,
        );
      },
      ...
      renderTick: function (a, b) {
        ...
        if (!c || (a >= this.min && a <= this.max))
          d[a] || (d[a] = new v(this, a)), h && d[a].isNew && d[a].render(b, !0, 0.1), d[a].render(b);
      },
      render: function () {
        var b = this,
          c = b.chart,
        ...
        if (b.hasData() || m)
          b.minorTickInterval &&
            !b.categories &&
            p(b.getMinorTickPositions(), function (a) {
              b.renderMinorTick(a);
            }),
            w.length &&
              (p(w, function (a, c) {
              ...
              f && (0 === b.min || b.single) && (t[-1] || (t[-1] = new v(b, -1, null, !0)), t[-1].render(-1))),
            I &&
              p(w, function (d, k) {
                ...
                0 === k % 2 &&
                  d < b.max &&
                  u <= b.max + (c.polar ? -f : f) &&
                  (x[d] || (x[d] = new a.PlotLineOrBand(b)),
                  (y = d + f),
                  (x[d].options = {
            ...
            b._addedPlotLB ||
              (p((d.plotLines || []).concat(d.plotBands || []), function (a) {
        ...
        n &&
          ...
          B(d.y) ? (n[n.isNew ? "attr" : "animate"](d), (n.isNew = !1)) : (n.attr("y", -9999), (n.isNew = !0)));
      ...
      destroy: function (a) {
        ...
        for (v in b.plotLinesAndBandsGroups) b.plotLinesAndBandsGroups[v] = b.plotLinesAndBandsGroups[v].destroy();
        z(b, function (a, d) {
      ...
      drawCrosshair: function (a, b) {
        ...
        if (this.crosshair && !1 !== (C(b) || !h)) {
          h
            ? C(b) && (k = D(b.crosshairPos, this.isXAxis ? b.plotX : this.len - b.plotY))
            : (k = a && (this.horiz ? a.chartX - this.pos : this.len - a.chartY + this.pos));
          ...
          v ||
            ((this.cross = v =
              this.chart.renderer
                .path()
                .addClass("highcharts-crosshair highcharts-crosshair-" + (h ? "category " : "thin ") + d.className)
                .attr({
                  zIndex: D(d.zIndex, 2),
                })
                .add()),
            v
              .attr({
                stroke: d.color || (h ? l("#ccd6eb").setOpacity(0.25).get() : "#cccccc"),
  ...
  (function (a) {
    ...
    E.prototype.normalizeTimeTickInterval = function (a, f) {
      ...
      for (
        y = 0;
        y < l.length &&
        !((f = l[y]), (C = q[f[0]]), (r = f[1]), l[y + 1] && a <= (C * r[r.length - 1] + q[l[y + 1][0]]) / 2);
        y++
      );
  ...
  (function (a) {
    ...
    E.prototype.getLogTickPositions = function (a, u, C, r) {
      ...
      if (0.5 <= a) (a = Math.round(a)), (d = this.getLinearTickPositions(a, u, C));
      else if (0.08 <= a)
        for (
          var p = Math.floor(u),
            e,
            ...
            b,
            c,
            f = 0.3 < a ? [1, 2, 4] : 0.15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9];
          p < C + 1 && !c;
          p++
        )
          for (g = f.length, e = 0; e < g && !c; e++)
            (m = this.log2lin(this.lin2log(p) * f[e])),
              m > u && (!r || b <= C) && void 0 !== b && d.push(b),
              b > C && (c = !0),
              (b = m);
      else
        (u = this.lin2log(u)),
          (C = this.lin2log(C)),
          (a = r ? this.getMinorTickInterval() : f.tickInterval),
          (a = l(
            "auto" === a ? null : a,
            this._minorAutoInterval,
            ((f.tickPixelInterval / (r ? 5 : 1)) * (C - u)) / ((r ? p / this.tickPositions.length : p) || 1),
          )),
          (a = q(a, null, F(a))),
          (d = G(this.getLinearTickPositions(a, u, C), this.log2lin)),
  ...
  (function (a, E) {
    ...
    a.PlotLineOrBand.prototype = {
      render: function () {
        ...
        t
          ? ((z.stroke = D), (z["stroke-width"] = e.width), e.dashStyle && (z.dashstyle = e.dashStyle))
          : B &&
            (D && (z.fill = D), e.borderWidth && ((z.stroke = e.borderColor), (z["stroke-width"] = e.borderWidth)));
        H.zIndex = h;
        w += "-" + h;
        (D = p.plotLinesAndBandsGroups[w]) ||
          (p.plotLinesAndBandsGroups[w] = D =
            v
              .g("plot-" + w)
              .attr(H)
              .add());
        ...
        g && q(g.text) && z && z.length && 0 < p.width && 0 < p.height && !z.isFlat
          ? ((g = C(
              {
                align: d && B && "center",
                x: d ? !B && 4 : 10,
      ...
      renderLabel: function (a, p, d, e) {
        ...
        g ||
          ...
          (g.zIndex = e),
          (this.label = g = m.text(a.text, 0, 0, a.useHTML).attr(g).add()),
          g.css(a.style));
    ...
    a.extend(E.prototype, {
      getPlotBandPath: function (a, p) {
        ...
        if (e && d)
          for (a && ((c = e.toString() === d.toString()), (b = 0)), a = 0; a < e.length; a += 6)
            m && d[a + 1] === e[a + 1]
              ? ((d[a + 1] += b), (d[a + 4] += b))
              : m || d[a + 2] !== e[a + 2] || ((d[a + 2] += b), (d[a + 5] += b)),
      ...
      removePlotBandOrLine: function (a) {
        for (var p = this.plotLinesAndBands, d = this.options, e = this.userOptions, g = p.length; g--; )
          p[g].id === a && p[g].destroy();
    ...
    a.Tooltip.prototype = {
      ...
      getLabel: function () {
        ...
        this.label ||
          (this.outside &&
            ...
            (this.renderer = d = new a.Renderer(g, 0, 0))),
          this.split
            ? (this.label = d.g("tooltip"))
            : ((this.label = d.label("", 0, 0, e.shape || "callout", null, null, e.useHTML, null, "tooltip").attr({
                padding: e.padding,
                r: e.borderRadius,
              })),
              this.label
      ...
      getAnchor: function (a, e) {
        ...
        this.followPointer && e
          ? (void 0 === e.chartX && (e = m.normalize(e)), (a = [e.chartX - d.plotLeft, e.chartY - c]))
          : a[0].tooltipPos
          ? (a = a[0].tooltipPos)
          : (F(a, function (a) {
              n = a.series.yAxis;
              ...
              t += (a.plotLow ? (a.plotLow + a.plotHigh) / 2 : a.plotY) + (!b && n ? n.top - c : 0);
            }),
            (B /= a.length),
            (t /= a.length),
            (a = [
              b ? d.plotWidth - t : B,
              this.shared && !b && 1 < a.length && e ? e.chartY - c : b ? d.plotHeight - B : t,
            ]));
      ...
      getPosition: function (a, e, g) {
        var d = this.chart,
          ...
          D = [
            ...
            p,
            e,
            (t ? z.top - b : 0) + g.plotY + d.plotTop,
            t ? 0 : d.plotTop,
            t ? p : d.plotTop + d.plotHeight,
          ],
          h = [
            "x",
            n,
            a,
            (t ? z.left - b : 0) + g.plotX + d.plotLeft,
            t ? 0 : d.plotLeft,
            t ? n : d.plotLeft + d.plotWidth,
          ],
      ...
      refresh: function (d, e) {
        ...
        m.enabled &&
          (a.clearTimeout(this.hideTimer),
          (this.followPointer = r(c)[0].series.tooltipOptions.followPointer),
          (x = this.getAnchor(c, e)),
          (e = x[0]),
          (b = x[1]),
          !B || (c.series && c.series.noSharedTooltip)
            ? (B = c.getLabelConfig())
            : (F(c, function (a) {
                a.setState("hover");
              ...
              this.split
                ...
                : (m.style.width ||
                  ...
                  g
                    ...
                    .addClass("highcharts-color-" + C(c.colorIndex, n.colorIndex)),
                  g.attr({
        ...
        F(d.slice(0, e.length + 1), function (a, d) {
          if (!1 !== a) {
            ...
            H ||
              (h.tt = H =
                c
                  .label(null, null, null, "callout", null, null, B.useHTML)
                  .addClass("highcharts-tooltip-box " + w + (d.isHeader ? " highcharts-tooltip-header" : ""))
                  .attr({
                    padding: B.padding,
                    r: B.borderRadius,
            ...
            d.isHeader
              ? ((t = a.height),
                b.xAxis[0].opposite && ((n = !0), (z -= t)),
                (v = Math.max(
                  0,
                  Math.min(
                    d.plotX + b.plotLeft - v / 2,
                    b.chartWidth + (b.scrollablePixels ? b.scrollablePixels - b.marginRight : 0) - v,
                  ),
                )))
              : (v = d.plotX + b.plotLeft - C(B.distance, 16) - v);
            0 > v && (x = !1);
      ...
      updatePosition: function (a) {
        ...
        var c;
        this.outside &&
          ((c = (this.options.borderWidth || 0) + 2 * this.distance),
          this.renderer.setSize(g.width + c, g.height + c, !1),
          (b += d.pointer.chartPosition.left - m.x),
          (a += d.pointer.chartPosition.top - m.y));
      ...
      bodyFormatter: function (a) {
        return f(a, function (a) {
          ...
          return (d[(a.point.formatPrefix || "point") + "Formatter"] || a.point.tooltipFormatter).call(
            a.point,
    ...
    a.Pointer.prototype = {
        ...
        c &&
          (n && !m.noSharedTooltip
            ? ((z = a.grep(e, function (a) {
                return (
                  a.visible && !(!n && a.directTouch) && g(a.options.enableMouseTracking, !0) && !a.noSharedTooltip
                );
              })),
              u(z, function (a) {
      ...
      runPointActions: function (b, d) {
        var c = this.chart,
          ...
          x = this.getHoverData(
            ...
            x,
            c.series,
            "touchmove" !== b.type && (!!d || (x && x.directTouch && this.isDirectTouch)),
            n,
            b,
            {
        ...
        this.unDocMouseMove ||
          (this.unDocMouseMove = E(c.container.ownerDocument, "mousemove", function (b) {
      ...
      scaleGroups: function (a, b) {
        ...
        u(c.series, function (m) {
          ...
          m.xAxis &&
            ...
            m.group &&
            (m.group.attr(d),
            m.markerGroup && (m.markerGroup.attr(d), m.markerGroup.clip(b ? c.clipRect : null)),
            m.dataLabelsGroup && m.dataLabelsGroup.attr(d));
        });
      ...
      drag: function (a) {
        ...
        (w && w.touch) ||
          (d < D ? (d = D) : d > D + p && (d = D + p),
          m < h ? (m = h) : m > h + H && (m = h + H),
          (this.hasDragged = Math.sqrt(Math.pow(k - d, 2) + Math.pow(A - m, 2))),
          10 < this.hasDragged &&
            ((v = b.isInsidePlot(k - D, A - h)),
            b.hasCartesianSeries &&
              ...
              (this.selectionMarker = w =
                b.renderer
                  .rect(D, h, e ? 1 : p, g ? 1 : H, 0)
                  .attr({
                    fill: c.selectionMarkerFill || q("#335cad").setOpacity(0.25).get(),
      ...
      onContainerMouseMove: function (b) {
        var c = this.chart;
        (f(a.hoverChartIndex) && G[a.hoverChartIndex] && G[a.hoverChartIndex].mouseIsDown) ||
      ...
      onContainerClick: function (a) {
        ...
        b.cancelClick ||
          (c && this.inClass(a.target, "highcharts-tracker")
            ...
            : (C(a, this.getCoordinates(a)), b.isInsidePlot(a.chartX - d, a.chartY - m) && y(b, "click", a)));
      },
  ...
  (function (a) {
    ...
    G(a.Pointer.prototype, {
      pinchTranslate: function (a, f, l, q, p, d) {
        this.zoomHor && this.pinchTranslateDirection(!0, a, f, l, q, p, d);
      ...
      pinchTranslateDirection: function (a, f, l, q, p, d, e, g) {
        ...
        l();
        f = r;
        f < h.min ? ((f = h.min), (A = !0)) : f + n > h.max && ((f = h.max - n), (A = !0));
        A ? ((v -= 0.8 * (v - e[b][0])), I || (k -= 0.8 * (k - e[b][1])), l()) : (e[b] = [v, k]);
        D || ((d[b] = r - t), (d[B] = n));
        d = D ? 1 / z : z;
        p[B] = n;
        p[b] = f;
      ...
      pinch: function (a) {
        ...
        "touchstart" === a.type
          ? (F(p, function (a, b) {
            ...
            (e.x = [y[0].chartX, y[1] && y[1].chartX]),
            (e.y = [y[0].chartY, y[1] && y[1].chartY]),
            F(r.axes, function (a) {
              if (a.zoomEnabled) {
      ...
      touch: function (l, q) {
        ...
        1 === l.touches.length
          ? ((l = this.normalize(l)),
            (p = r.isInsidePlot(l.chartX - r.plotLeft, l.chartY - r.plotTop)) && !r.openMenu
              ? (q && this.runPointActions(l),
                "touchmove" === l.type &&
                  ((q = this.pinchDown),
                  (u = q[0]
                    ? 4 <= Math.sqrt(Math.pow(q[0].chartX - l.chartX, 2) + Math.pow(q[0].chartY - l.chartY, 2))
                    : !1)),
                f(u, !0) && this.pinch(l))
              : q && this.reset())
    ...
    if (!a.hasTouch && (r.PointerEvent || r.MSPointerEvent)) {
      ...
      l(u.prototype, {
        onContainerPointerDown: function (a) {
          g(a, "onContainerTouchStart", "touchstart", function (a) {
            p[a.pointerId] = {
              pageX: a.pageX,
              pageY: a.pageY,
  ...
  (function (a) {
    ...
    a.Legend.prototype = {
      ...
      positionItems: function () {
        l(this.allItems, this.positionItem, this);
          ...
          l(
            ...
            function (e) {
              var m = e.checkbox,
                n;
              m &&
                ((n = b + d + m.y + (this.scrollOffset || 0) + 3),
                F(m, {
        ...
        c.text &&
          (this.title ||
            (this.title = this.chart.renderer
              .label(c.text, b - 3, b - 4, null, null, null, a.useHTML, null, "legend-title")
              .attr({
                zIndex: 1,
              })
              .css(c.style)
      ...
      renderItem: function (a) {
        ...
        h ||
          ...
          (a.legendItem = h =
            c
              .text("", p ? e + m : -m, this.baseline || 0, w)
              .css(r(a.visible ? n : g))
              .attr({
                align: p ? "left" : "right",
                zIndex: 2,
          ...
          this.baseline ||
            ((e = n.fontSize),
            (this.fontMetrics = c.fontMetrics(e, h)),
          ...
          this.setItemEvents && this.setItemEvents(a, h, w),
      ...
      layoutItem: function (a) {
        ...
        d &&
          this.itemX - c + b > p &&
          ((this.itemX = c), (this.itemY += n + this.lastLineHeight + m), (this.lastLineHeight = 0));
        this.lastItemY = n + this.itemY + m;
        this.lastLineHeight = Math.max(e, this.lastLineHeight);
        a._legendItemPos = [this.itemX, this.itemY];
        d ? (this.itemX += b) : ((this.itemY += n + e + m), (this.lastLineHeight = e));
        this.offsetWidth = z || Math.max((d ? this.itemX - c - (a.checkbox ? 0 : g) : b) + c, this.offsetWidth);
      },
      getAllItems: function () {
        ...
        l(this.chart.series, function (b) {
          var c = b && b.options;
          b &&
            y(c.showInLegend, q(c.linkedTo) ? !1 : void 0, !0) &&
      ...
      adjustMargins: function (a, b) {
        var c = this.chart,
          ...
          e = this.getAlignment();
        e &&
          l([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/], function (m, n) {
            m.test(e) &&
              !q(a[n]) &&
              (c[C[n]] = Math.max(
                c[C[n]],
                c.legend[(n + 1) % 2 ? "legendHeight" : "legendWidth"] +
                  ...
                  y(d.margin, 12) +
                  b[n] +
                  (0 === n && void 0 !== c.options.title.margin ? c.titleOffset + c.options.title.margin : 0),
              ));
          });
      },
        ...
        l(
          ...
          function (e) {
            ...
            e.xAxis &&
              ...
              (m = a.find(m ? e.points : e.points.slice(0).reverse(), function (b) {
                return a.isNumber(b.plotY);
              })),
              (g = e.legendGroup.getBBox().height),
              b.push({
                target: e.visible ? (m ? m.plotY : e.xAxis.height) - 0.3 * g : d.plotHeight,
                size: g,
                item: e,
              }));
          },
      ...
      handleOverflow: function (a) {
        ...
        v.length = 0;
        a > c && !1 !== f.enabled
          ? ((this.clipHeight = g = Math.max(c - 20 - this.titleHeight - n, 0)),
            ...
            l(k, function (a, b) {
              var c = a._legendItemPos[1],
                ...
                h = v.length;
              if (!h || (c - v[h - 1] > g && (w || c) !== v[h - 1])) v.push(w || c), h++;
              a.pageIx = h - 1;
              w && (k[b - 1].pageIx = h - 1);
              b === k.length - 1 && c + d - v[h - 1] > g && (v.push(c), (a.pageIx = h));
              c !== w && (w = c);
            }),
            p || ((p = b.clipRect = d.clipRect(0, n, 9999, 0)), b.contentGroup.clip(p)),
            A(g),
            H ||
              ((this.nav = H =
                d
              ...
              (this.up = d
                ...
                .add(H)),
              (this.pager = d.text("", 15, 10).addClass("highcharts-legend-navigation").css(f.style).add(H)),
              (this.down = d
    ...
    (/Trident\/7\.0/.test(e.navigator.userAgent) || u) &&
      g(a.Legend.prototype, "positionItem", function (a, b) {
        var c = this,
          d = function () {
  ...
  (function (a) {
    ...
    g(T.prototype, {
      ...
      redraw: function (c) {
        ...
        if (p) for (c = h.length; c--; ) (z = h[c]), z.options.stacking && (z.isDirty = !0);
        e(h, function (a) {
          a.isDirty &&
            ("point" === a.options.legendType
              ? (a.updateTotals && a.updateTotals(), (n = !0))
              : w && (w.labelFormatter || w.labelFormat) && (n = !0));
          a.isDirtyData && b(a, "updatedData");
        });
        n && v && v.options.enabled && (v.render(), (this.isDirtyLegend = !1));
        m && this.getStacks();
        A &&
          e(d, function (a) {
            a.updateNames();
      ...
      layOutTitles: function (a) {
        ...
        !this.isDirtyBox &&
          ...
          this.hasRendered && I(a, !0) && this.isDirtyBox && this.redraw());
      },
        ...
        if (b)
          for (; c && c.style; )
            c.hcOrigStyle && (a.css(c, c.hcOrigStyle), delete c.hcOrigStyle),
              c.hcOrigDetached && (l.body.removeChild(c), (c.hcOrigDetached = !1)),
              (c = c.parentNode);
        else
          for (; c && c.style; ) {
      ...
      reflow: function (b) {
        ...
        if (!v && !c.isPrinting && e && h && (k === Q || k === l)) {
          if (e !== c.containerWidth || h !== c.containerHeight)
      ...
      setReflow: function (a) {
        ...
        !1 === a || this.unbindReflow
          ...
          : ((this.unbindReflow = E(Q, "resize", function (a) {
              b.reflow(a);
            })),
      ...
      linkSeries: function () {
        ...
        e(c, function (b) {
          ...
          t(c) &&
            ...
            (b.linkedParent = c),
            (b.visible = I(b.options.visible, c.options.visible, b.visible)));
        });
  ...
  (function (a) {
    ...
    E(F, "afterSetChartSize", function (q) {
      ...
      (l = l && l.minWidth) &&
        ...
        (this.scrollablePixels = l = Math.max(0, l - this.chartWidth)) &&
        ((this.plotWidth += l),
        (this.clipBox.width += l),
        q.skipAxes ||
          G(this.axes, function (f) {
            1 === f.side
    ...
    F.prototype.applyFixed = function () {
      ...
      u &&
        ...
        (this.fixedRenderer = l = new a.Renderer(this.fixedDiv, 0, 0)),
  ...
  (function (a) {
    ...
    a.Point.prototype = {
      ...
      optionsToObject: function (p) {
        ...
        if (C(p) || null === p) d[m[0]] = p;
          ...
          for (
            !g &&
            p.length > b &&
            ((e = typeof p[0]), "string" === e ? (d.name = p[0]) : "number" === e && (d.x = p[0]), c++);
            f < b;

          )
            (g && void 0 === p[c]) ||
              (0 < m[f].indexOf(".") ? a.Point.prototype.setNestedProperty(d, p[c], m[f]) : (d[m[f]] = p[c])),
              c++,
              f++;
        else
          "object" === typeof p &&
            ((d = p), p.dataLabels && (e._hasPointLabels = !0), p.marker && (e._hasPointMarkers = !0));
        return d;
      },
      ...
      destroyElements: function () {
        for (var a = ["graphic", "dataLabel", "dataLabelUpper", "connector", "shadowGroup"], d, e = 6; e--; )
      ...
      },
      {
        ...
        bindAxes: function () {
          ...
          r(b.axisTypes || [], function (h) {
            r(d[h], function (a) {
              v = a.options;
              if (c[h] === v.index || (void 0 !== c[h] && c[h] === v.id) || (void 0 === c[h] && 0 === v.index))
        ...
        setOptions: function (a) {
          ...
          this.tooltipOptions = c(
            f.tooltip,
            f.plotOptions.series && f.plotOptions.series.tooltip,
            f.plotOptions[this.type].tooltip,
            h.tooltip.userOptions,
            v.series && v.series.tooltip,
            v[this.type].tooltip,
            a.tooltip,
          );
        ...
        getCyclic: function (a, b, c) {
          ...
          b ||
            ((d = B(k[e], k["_" + e])),
            C(d) || (h.series.length || (h[n] = 0), (k["_" + e] = d = h[n] % g), (h[n] += 1)),
            c && (b = c[d]));
          void 0 !== d && (this[e] = d);
          this[a] = b;
        },
        ...
        updateData: function (b) {
          ...
          r(
            ...
            function (b) {
              ...
              m(k) &&
                ((k = a.inArray(k, this.xData, n)),
                -1 === k || d[k].touched
                  ? h.push(b)
                  : b !== c.data[k]
                  ? (d[k].update(b, !1, null, !1), (d[k].touched = !0), g && (n = k + 1))
                  : d[k] && (d[k].touched = !0),
                (e = !0));
            },
            this,
          );
          if (e) for (b = d.length; b--; ) (k = d[b]), k.touched || k.remove(!1), (k.touched = !1);
        ...
        setData: function (c, d, e, v) {
          ...
          if (!q) {
            ...
            if (l && z > l) {
              ...
              if (m(p)) for (e = 0; e < z; e++) (x[e] = this.autoIncrement()), (H[e] = c[e]);
              else if (g(p))
                if (I) for (e = 0; e < z; e++) (p = c[e]), (x[e] = p[0]), (H[e] = p.slice(1, I + 1));
                else for (e = 0; e < z; e++) (p = c[e]), (x[e] = p[0]), (H[e] = p[1]);
              else a.error(12);
            } else
              for (e = 0; e < z; e++)
                void 0 !== c[e] &&
                  ...
                  h.pointClass.prototype.applyOptions.apply(p, [c[e]]),
                  h.updateParallelArrays(p, e));
        ...
        processData: function (b) {
          ...
          t &&
            this.sorted &&
            !p &&
            (!m || h > m || this.forceCrop) &&
            (c[h - 1] < l || c[0] > x
              ? ((c = []), (d = []))
              : this.yData &&
                (c[0] < l || c[h - 1] > x) &&
                ((e = this.cropData(this.xData, this.yData, l, x)),
                (c = e.xData),
                (d = e.yData),
                (e = e.start),
                (k = !0)));
          for (m = c.length || 1; --m; )
            (h = f ? z(c[m]) - z(c[m - 1]) : c[m] - c[m - 1]),
              0 < h && (void 0 === n || h < n) ? (n = h) : 0 > h && D && (a.error(15), (D = !1));
          this.cropped = k;
          this.cropStart = e;
        ...
        generatePoints: function () {
          ...
          for (x = 0; x < m; x++)
            (t = z + x),
              f
                ? ((D = new g().init(this, [e[x]].concat(n(k[x])))),
                  (D.dataGroup = this.groupMap[x]),
                  D.dataGroup.options && ((D.options = D.dataGroup.options), p(D, D.dataGroup.options)))
                : (D = c[t]) || void 0 === b[t] || (c[t] = D = new g().init(this, b[t], e[x])),
              D && ((D.index = t), (l[x] = D));
          this.options.keys = a;
          if (c && (m !== (d = c.length) || f))
        ...
        getExtremes: function (a) {
          ...
          for (D = 0; D < d; D++)
            if (
              ((t = c[D]),
              (p = a[D]),
              (z = (m(p, !0) || g(p)) && (!b.positiveValuesOnly || p.length || 0 < p)),
              (t =
              ...
              if ((z = p.length)) for (; z--; ) "number" === typeof p[z] && (h[k++] = p[z]);
              else h[k++] = p;
          this.dataMin = q(h);
          this.dataMax = G(h);
        },
        translate: function () {
          ...
          for (a = 0; a < g; a++) {
            ...
            b &&
              ...
              G &&
              G[F] &&
              ((u = this.getStackIndicator(u, F, this.index)),
              (J = G[F]),
              (E = J.points[u.key]),
              (r = E[0]),
              (E = E[1]),
              r === D && u.key === G[F].base && (r = B(m(f) && f, n.min)),
              n.positiveValuesOnly && 0 >= r && (r = null),
              (y.total = y.stackTotal = J.total),
              (y.percentage = J.total && (y.y / J.total) * 100),
              (y.stackY = E),
            ...
            y.plotY = r =
              "number" === typeof E && Infinity !== E
                ? Math.min(Math.max(-1e5, n.translate(E, 0, 1, 0, 1)), 1e5)
                : void 0;
            y.isInside = void 0 !== r && 0 <= r && r <= n.len && 0 <= x && x <= c.len;
        ...
        setClip: function (a) {
          var b = this.chart,
            ...
            e = k || b.clipBox,
            n =
              this.sharedClipKey || ["_sharedClip", a && a.duration, a && a.easing, e.height, c.xAxis, c.yAxis].join(),
            g = b[n],
            m = b[n + "m"];
          g ||
            (a &&
              ...
              (b[n + "m"] = m =
                d.clipRect(
                  h ? b.plotSizeX + 99 : -99,
                  h ? -b.plotLeft : -b.plotTop,
                  99,
                  h ? b.chartWidth : b.chartHeight,
                ))),
            (b[n] = g = d.clipRect(e)),
            (g.count = {
              length: 0,
          ...
          !1 !== c.clip &&
            (this.group.clip(a || k ? g : b.clipRect), this.markerGroup.clip(m), (this.sharedClipKey = n));
          a ||
            (g.count[this.index] && (delete g.count[this.index], --g.count.length),
            0 === g.count.length &&
              n &&
              b[n] &&
              (k || (b[n] = b[n].destroy()), b[n + "m"] && (b[n + "m"] = b[n + "m"].destroy())));
        },
        animate: function (a) {
          var b = this.chart,
          ...
          if (!1 !== n.enabled || this._hasPointMarkers)
            for (c = 0; c < a.length; c++)
              (d = a[c]),
                ...
                (g = d.marker || {}),
                (m = !!d.marker),
                (e = (f && void 0 === g.enabled) || g.enabled),
                (z = d.isInside),
                e && !d.isNull
                  ? ((e = B(g.symbol, this.symbol)),
                    (t = this.markerAttribs(d, d.selected && "select")),
                    k
                      ? k[z ? "show" : "hide"](!0).animate(t)
                      : z &&
                        (0 < t.width || d.hasImage) &&
                        (d.graphic = k = b.renderer.symbol(e, t.x, t.y, t.width, t.height, m ? g : n).add(p)),
        ...
        markerAttribs: function (a, b) {
          ...
          b &&
            ...
            (k = B(b && b.radius, c && c.radius, k + ((c && c.radiusPlus) || 0))));
        ...
        pointAttribs: function (a, b) {
          ...
          b &&
            ...
            (d = B(b.lineWidth, c.lineWidth, d + B(b.lineWidthPlus, c.lineWidthPlus, 0))),
            (a = b.fillColor || c.fillColor || a),
            (k = b.lineColor || c.lineColor || k));
          return {
            stroke: k,
            "stroke-width": d,
            fill: a,
          ...
          r(a, function (h, v) {
            ...
            h.isNull && !C(b) && 0 < v
              ...
              : (0 === v || m
                  ? (v = ["M", h.plotX, h.plotY])
                  : d.getPointSpline
                  ? (v = d.getPointSpline(a, h, v))
                  : k
                  ? ((v =
                      1 === k
                        ? ["L", p.plotX, z]
                        : 2 === k
                        ? ["L", (p.plotX + w) / 2, p.plotY, "L", (p.plotX + w) / 2, z]
                        : ["L", w, p.plotY]),
                    v.push("L", w, z))
                  : (v = ["L", w, z]),
                g.push(h.x),
                k && (g.push(h.x), 2 === k && g.push(h.x)),
                n.push.apply(n, v),
                (m = !1));
          });
          n.xMap = g;
          ...
          r(d, function (d, k) {
            ...
            h
              ...
              : c.length &&
                ...
                (h = a[e].attr(h).shadow(2 > k && b.shadow)));
        ...
        getZonesGraphs: function (a) {
          r(
            ...
            function (b, c) {
              a.push([
                "zone-graph-" + c,
                "highcharts-graph highcharts-zone-graph-" + c + " " + (b.className || ""),
                b.color || this.color,
        ...
        applyZones: function () {
          ...
          d.length &&
            ...
            r(d, function (d, h) {
              ...
              k = Math.min(Math.max(Math.round(t.toPixels(B(d.value, f.max), !0)), 0), p);
              ...
              n[h]
                ? n[h].animate(g)
                : ((n[h] = c.clipRect(g)), m && a["zone-graph-" + h].clip(n[h]), z && a["zone-area-" + h].clip(n[h]));
              y = d.value > f.max;
        ...
        searchKDTree: function (a, b) {
          function c(a, b, n, g) {
            ...
            w = 0 > m ? "left" : "right";
            z = 0 > m ? "right" : "left";
            b[w] && ((w = c(a, b[w], n + 1, g)), (p = w[h] < p[h] ? w : v));
  ...
  (function (a) {
    ...
    a.StackItem.prototype = {
      ...
      render: function (a) {
        var d = this.axis.chart,
          e = this.options,
          g = e.format,
          g = g ? u(g, this, d.time) : e.formatter.call(this);
        this.label
          ? this.label.attr({
              text: g,
              visibility: "hidden",
            })
          : (this.label = d.renderer
      ...
      setOffset: function (a, d) {
        ...
        (d = this.label) &&
          ...
          (e = d.alignAttr),
          d[!1 === this.options.crop || g.isInsidePlot(e.x, e.y) ? "show" : "hide"](!0));
      },
    ...
    y.prototype.setStackedPoints = function () {
      if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
        ...
        for (w = 0; w < g; w++)
          (k = f[w]),
            (A = d[w]),
            (h = this.getStackIndicator(h, k, this.index)),
            (v = h.key),
            (H = (I = n && A < (c ? 0 : b)) ? t : B),
            z[H] || (z[H] = {}),
            z[H][k] ||
              (D[H] && D[H][k]
                ? ((z[H][k] = D[H][k]), (z[H][k].total = null))
                : (z[H][k] = new a.StackItem(u, u.options.stackLabels, I, k, l))),
            (H = z[H][k]),
            null !== A
              ? ((H.points[v] = H.points[this.index] = [r(H.cumulative, c)]),
                q(H.cumulative) || (H.base = v),
                (H.touched = u.stacksTouched),
                0 < h.index && !1 === this.singleStacks && (H.points[v][0] = H.points[this.index + "," + k + ",0"][0]))
              : (H.points[v] = H.points[this.index] = null),
            "percent" === m
              ? ((I = I ? B : t),
                n && z[I] && z[I][k]
                  ? ((I = z[I][k]), (H.total = I.total = Math.max(I.total, H.total) + Math.abs(A) || 0))
                  : (H.total = G(H.total + (Math.abs(A) || 0))))
              : (H.total = G(H.total + (A || 0))),
            (H.cumulative = r(H.cumulative, c) + (A || 0)),
            null !== A && (H.points[v].push(H.cumulative), (e[w] = H.cumulative));
      ...
      a[b + "Stacker"] &&
        f([d, "-" + d], function (c) {
          for (var d = g.length, f, t; d--; )
            if (
              ((f = g[d]), (m = a.getStackIndicator(m, f, a.index, c)), (t = (f = e[c] && e[c][f]) && f.points[m.key]))
            )
              a[b + "Stacker"](t, f, d);
        });
    };
    ...
    y.prototype.getStackIndicator = function (a, d, e, g) {
      !q(a) || a.x !== d || (g && a.key !== g)
        ? (a = {
            x: d,
            index: 0,
  ...
  (function (a) {
    ...
    r(a.Chart.prototype, {
      ...
      update: function (a, e, h, n) {
        ...
        if (w) {
          ...
          "alignTicks" in w && (k = !0);
          b(w, function (a, b) {
            -1 !== p("chart." + b, g.propsRequireUpdateSeries) && (t = !0);
            -1 !== p(b, g.propsRequireDirtyBox) && (g.isDirtyBox = !0);
          });
        ...
        u("xAxis yAxis zAxis series colorAxis pane".split(" "), function (b) {
          ...
          a[b] &&
            ...
            u(L(a[b]), function (a, d) {
              (d = (f(a.id) && g.get(a.id)) || g[b][c ? c[d] : d]) &&
                d.coll === b &&
        ...
        t &&
          u(g.series, function (a) {
            a.update({}, !1);
          });
        a.loading && m(!0, g.options.loading, a.loading);
        k = w && w.width;
        w = w && w.height;
        (d(k) && k !== g.chartWidth) || (d(w) && w !== g.chartHeight) ? g.setSize(k, w, n) : c(e, !0) && g.redraw(n);
        y(g, "afterUpdate", {
          options: a,
        });
      },
    ...
    r(x.prototype, {
      update: function (a, b, d, g) {
        function h() {
          ...
          e(a, !0) &&
            (k && k.element && a && a.marker && void 0 !== a.marker.symbol && (n.graphic = k.destroy()),
            a && a.dataLabels && n.dataLabel && (n.dataLabel = n.dataLabel.destroy()),
            n.connector && (n.connector = n.connector.destroy()));
          t = n.index;
          m.updateParallelArrays(n, t);
          z.data[t] = e(z.data[t], !0) || e(a, !0) ? n.options : c(a, z.data[t]);
    ...
    r(B.prototype, {
      addPoint: function (a, b, d, e) {
        ...
        l = t.x;
        p = z.length;
        if (this.requireSorting && l < z[p - 1]) for (f = !0; p && z[p - 1] > l; ) p--;
      ...
      update: function (b, d) {
        var e = this,
          ...
          k = t[v].prototype,
          f,
          z = ["group", "markerGroup", "dataLabelsGroup"],
    ...
    r(G.prototype, {
      ...
      remove: function (a) {
        ...
        C(b.axes, this);
        C(b[d], this);
        g(b.options[d]) ? b.options[d].splice(this.options.index, 1) : delete b.options[d];
        u(b[d], function (a, b) {
      ...
      },
      {
        ...
        getStackPoints: function (f) {
          var l = [],
            ...
            b = m.length,
            c,
            x = q(p.options.reversedStacks, !0) ? 1 : -1,
            B;
          f = f || this.points;
                ...
                l.push(e[a]),
                  F([-1, 1], function (h) {
                    ...
                    if (v)
                      for (B = g; 0 <= B && B < b; )
                        (f = v.points[B]),
                          f || (B === g ? (e[a][m] = !0) : c[B] && (t = d[a].points[B]) && (p -= t[1] - t[0])),
                          (B += x);
        ...
        getGraphPath: function (a) {
          var f = l.prototype.getGraphPath,
            ...
            L = function (d, e, h) {
              ...
              var v,
                ...
                n = !0;
              h || f
                ? ((v = (f ? d[0] : d[1]) + h), (w = d[0] + h), (n = !!f))
                : !u && a[e] && a[e].isNull && (v = w = B);
              void 0 !== v &&
                (m.push({
                  plotX: c,
          ...
          for (d = 0; d < a.length; d++)
            if (((e = a[d].isNull), (c = q(a[d].rectPlotX, a[d].plotX)), (n = q(a[d].yBottom, t)), !e || r))
              r || L(d, d - 1, "left"),
                (e && !u && r) ||
                  (m.push(a[d]),
                  g.push({
        ...
        drawGraph: function () {
          ...
          F(y, function (p) {
            var d = p[0],
              e = a[d];
            e
              ? ((e.endX = a.preventGraphAnimation ? null : f.xMap),
                e.animate({
                  d: f,
                }))
              : ((e = a[d] =
                  a.chart.renderer
                    ...
                    .addClass(p[1])
                    .attr({
                      fill: q(p[3], E(p[2]).setOpacity(q(r.fillOpacity, 0.75)).get()),
                      zIndex: 0,
                    })
                    .add(a.group)),
                (e.isArea = !0));
      ...
      {},
      {
        getPointSpline: function (a, G, q) {
          ...
          if (u && !u.isNull && !1 !== u.doCurve && !G.isCliff && q && !q.isNull && !1 !== q.doCurve && !G.isCliff) {
            ...
            p += d;
            r > a && r > f
              ? ((r = Math.max(a, f)), (p = 2 * f - r))
              : r < a && r < f && ((r = Math.min(a, f)), (p = 2 * f - r));
            p > q && p > f
              ? ((p = Math.max(q, f)), (r = 2 * f - p))
              : p < q && p < f && ((p = Math.min(q, f)), (r = 2 * f - p));
            G.rightContX = y;
            G.rightContY = p;
          }
    ...
    r(
      ...
      },
      {
          ...
          !1 === d.grouping
            ...
            : G(a.chart.series, function (d) {
                ...
                d.type !== a.type ||
                  ...
                  g.pos !== n.pos ||
                  (e.stacking
                    ? ((b = d.stackKey), void 0 === c[b] && (c[b] = f++), (h = c[b]))
                    : !1 !== e.grouping && (h = f++),
                  (d.columnIndex = h));
              });
          var l = Math.min(
              Math.abs(e.transA) * (e.ordinalSlope || d.pointRange || e.closestPointRange || e.tickInterval || 1),
              e.len,
            ),
            t = l * d.groupPadding,
            n = (l - 2 * t) / (f || 1),
        ...
        translate: function () {
          ...
          G(a.points, function (e) {
            ...
            f &&
              Math.abs(k) < f &&
              ((k = f),
              (w = (!m.reversed && !e.negative) || (m.reversed && e.negative)),
              e.y === b && a.dataMax <= b && m.min < b && (w = !w),
              (v = Math.abs(v - c) > f ? g - f : c - (w ? f : 0)));
            e.barX = l;
            e.pointWidth = t;
            e.tooltipPos = d.inverted
              ? [m.len + m.pos - d.plotLeft - h, a.xAxis.len - l - p / 2, k]
              : [l + p / 2, h + m.pos - d.plotTop, k];
            e.shapeType = "rect";
        ...
        pointAttribs: function (a, d) {
          ...
          d &&
            ((a = f(e.states[d], (a.options.states && a.options.states[d]) || {})),
            (d = a.brightness),
            (c = a.color || (void 0 !== d && F(c).brighten(a.brightness).get()) || c),
            (l = a[g] || l),
            (p = a[b] || p),
            (m = a.dashStyle || m));
          g = {
        ...
        drawPoints: function () {
          ...
          G(a.points, function (c) {
            ...
            if (l(c.plotY) && null !== c.y) {
              ...
              p[B](a.pointAttribs(c, c.selected && "select")).shadow(e.shadow, null, e.stacking && !e.borderRadius);
        ...
        animate: function (a) {
          ...
          y &&
            (a
              ? ((b.scaleY = 0.001),
                (a = Math.min(e.pos + e.len, Math.max(e.pos, e.toPixels(g.threshold)))),
                m ? (b.translateX = a - e.len) : (b.translateY = a),
                d.group.attr(b))
              : ((f = d.group.attr(c)),
                d.group.animate(
                  {
    ...
    a.CenteredSeriesMixin = {
      getCenter: function () {
        var a = this.options,
          ...
          d;
        for (p = 0; 4 > p; ++p)
          (d = r[p]), (a = 2 > p || (2 === p && /%$/.test(d))), (r[p] = q(d, [C, f, y, r[2]][p]) + (a ? u : 0));
        r[3] > r[2] && (r[3] = r[2]);
        return r;
      },
    ...
    d(
      ...
      },
      {
        ...
        updateTotals: function () {
          ...
          for (a = 0; a < c; a++) (e = b[a]), (d += f && !e.visible ? 0 : e.isNull ? 0 : e.y);
          this.total = d;
          for (a = 0; a < c; a++)
            (e = b[a]), (e.percentage = 0 < d && (e.visible || !f) ? (e.y / d) * 100 : 0), (e.total = d);
        },
        generatePoints: function () {
        ...
        translate: function (a) {
          ...
          for (u = 0; u < v; u++) {
            ...
            t = (Math.cos(n) * a[2]) / 2;
            h = (Math.sin(n) * a[2]) / 2;
            w.tooltipPos = [a[0] + 0.7 * t, a[1] + 0.7 * h];
            w.half = n < -Math.PI / 2 || n > Math.PI / 2 ? 1 : 0;
            w.angle = n;
            g = Math.min(e, w.labelDistance / 5);
            w.labelPos = [
              a[0] + t + Math.cos(n) * w.labelDistance,
              a[1] + h + Math.sin(n) * w.labelDistance,
              a[0] + t + Math.cos(n) * g,
              a[1] + h + Math.sin(n) * g,
              a[0] + t,
              a[1] + h,
        ...
        drawPoints: function () {
          ...
          q(a.points, function (n) {
            ...
            if (n.isNull) c && (n.graphic = c.destroy());
              ...
              c
                ? c.setRadialReference(a.center).attr(e).animate(l(f, b))
                : ((n.graphic = c = d[n.shapeType](f).setRadialReference(a.center).attr(b).add(a.group)),
                  c
                    .attr(e)
                    .attr({
                      "stroke-linejoin": "round",
      ...
      },
      {
        ...
        setVisible: function (a, d) {
          ...
          a !== b.visible &&
            ...
            (c.options.data[u(b, c.data)] = b.options),
  ...
  (function (a) {
    ...
    a.distribute = function (b, c, d) {
      ...
      for (
        ...
        for (f = b.length; f--; )
          (n = b[f]),
            (p = (Math.min.apply(0, n.targets) + Math.max.apply(0, n.targets)) / 2),
            (n.pos = Math.min(Math.max(0, p - n.size * n.align), c - n.size));
        f = b.length;
        for (n = !1; f--; )
          0 < f &&
      ...
      g(b, function (b) {
        var e = 0;
        if (
          g(b.targets, function () {
            l[f].pos = b.pos + e;
            if (Math.abs(l[f].pos - l[f].target) > d)
              return (
                q(l.slice(0, f + 1), function (a) {
                  delete a.pos;
                }),
                (l.reducedLen = (l.reducedLen || c) - 0.1 * c),
                l.reducedLen > 0.1 * c && a.distribute(l, c, d),
                !0
              );
            e += l[f].size;
            f++;
    ...
    d.prototype.drawDataLabels = function () {
      ...
      var c = this,
        ...
        h,
        r,
        u = y(g.defer, !!e.animation),
        v = d.renderer;
      if (g.enabled || c._hasPointLabels)
        c.dlProcessOptions && c.dlProcessOptions(g),
          (r = c.plotGroup("dataLabelsGroup", "data-labels", u && !p ? "hidden" : "visible", g.zIndex || 6)),
          u &&
            (r.attr({
              opacity: +p,
            }),
            p ||
              E(c, "afterAnimate", function () {
                c.visible && r.show(!0);
          ...
          q(n, function (n) {
            var k,
              ...
              D = !w,
              x;
            m = n.dlOptions || (n.options && n.options.dataLabels);
            (k = y(m && m.enabled, l.enabled) && !n.isNull) && (k = !0 === b(n, m || g));
            k &&
              ((g = C(l, m)),
              (t = n.getLabelConfig()),
              (x = g[n.formatPrefix + "Format"] || g.format),
              (h = G(x) ? f(x, t, d.time) : (g[n.formatPrefix + "Formatter"] || g.formatter).call(t, g)),
              (x = g.style),
              (t = g.rotation),
              (x.color = y(g.color, x.color, c.color, "#000000")),
              "contrast" === x.color &&
                ((n.contrastColor = v.getContrast(n.color || c.color)),
                (x.color = g.inside || 0 > y(n.labelDistance, g.distance) || e.stacking ? n.contrastColor : "#000000")),
            ...
            !w || (k && G(h))
              ? k &&
                ...
                (w
                  ...
                  : ((w = n.dataLabel =
                      t
                        ? v.text(h, 0, -9999, g.useHTML).addClass("highcharts-data-label")
                        : v.label(h, 0, -9999, g.shape, null, null, g.useHTML, null, "data-label")),
                    w.addClass(
                ...
                w.attr(p),
                w.css(x).shadow(g.shadow),
                w.added || w.add(r),
                c.alignDataLabel(n, w, g, null, D))
              : ((n.dataLabel = w = w.destroy()), z && (n.connector = z.destroy()));
          });
    ...
    d.prototype.alignDataLabel = function (a, c, d, e, g) {
      var b = this.chart,
        ...
        w =
          this.visible &&
          (a.series.forceDL ||
            b.isInsidePlot(f, Math.round(t), m) ||
            (e && b.isInsidePlot(f, m ? e.x + 1 : e.y + e.height - 1, m))),
        k = "justify" === y(d.overflow, "justify");
      if (
        w &&
        ((p = d.style.fontSize),
        (p = b.renderer.fontMetrics(p, c).b),
        (e = l(
          {
        ...
        x
          ? ((k = !1),
            ...
            "left" === v
              ...
              : "right" === v && ((f.x -= h.width), (f.y -= t ? 0 : h.height)),
            (c.placed = !0),
            (c.alignAttr = f))
          : (c.align(d, null, e), (f = c.alignAttr)),
        k && 0 <= e.height
          ? (a.isLabelJustified = this.justifyDataLabel(c, d, f, h, e, g))
          : y(d.crop, !0) && (w = b.isInsidePlot(f.x, f.y) && b.isInsidePlot(f.x + h.width, f.y + h.height)),
        d.shape && !x)
      )
        c[g ? "attr" : "animate"]({
    ...
    e.pie &&
              ...
              for (
                b.sortByAngle(c, d - 0.5),
                  0 < b.maxLabelDistance &&
                    ...
                    (m = Math.min(w + v + b.maxLabelDistance, g.plotHeight)),
                    q(c, function (a) {
                      0 < a.labelDistance &&
                        a.dataLabel &&
                        ((a.top = Math.max(0, w - v - a.labelDistance)),
                        (a.bottom = Math.min(w + v + a.labelDistance, g.plotHeight)),
                ...
                (e = c[S]),
                  (C = e.labelPos),
                  (k = e.dataLabel),
                  (M = !1 === e.visible ? "hidden" : "inherit"),
                  (N = h = C[1]),
                  z &&
                    G(e.distributeBox) &&
                    (void 0 === e.distributeBox.pos
                      ? (M = "hidden")
                      : ((E = e.distributeBox.size), (N = e.top + e.distributeBox.pos))),
                  delete e.positionIndex,
                  (O = f.justify
                    ? u[0] + (d ? -1 : 1) * (v + e.labelDistance)
                    : b.getX(N < e.top + 2 || N > e.bottom - 2 ? h : N, d, e)),
                  (k._attr = {
                    visibility: M,
                    align: C[6],
                  }),
                  ...
                  y(f.crop, !0) &&
                    ...
                    (h = null),
                    O - A < n && 1 === d
                      ? ((h = Math.round(A - O + n)), (R[3] = Math.max(h, R[3])))
                      : O + A > l - n && 0 === d && ((h = Math.round(O + A - l + n)), (R[1] = Math.max(h, R[1]))),
                    0 > N - E / 2
                      ? (R[0] = Math.max(Math.round(-N + E / 2), R[0]))
                      : N + E / 2 > p && (R[2] = Math.max(Math.round(N + E / 2 - p), R[2])),
                    (k.sideOverflow = h));
          }),
      ...
      (e.pie.prototype.connectorPath = function (a) {
        var b = a.x,
          d = a.y;
        return y(this.options.dataLabels.softConnector, !0)
          ? [
              "M",
              b + ("left" === a[6] ? 5 : -5),
              d,
      ...
      (e.pie.prototype.alignDataLabel = r),
      (e.pie.prototype.verifyDataLabelOverflow = function (a) {
        var b = this.center,
          d = this.options,
          e = d.center,
          g = d.minSize || 80,
        ...
        f ||
          (null !== e[0]
            ? (n = Math.max(b[2] - Math.max(a[1], a[3]), g))
            : ((n = Math.max(b[2] - a[1] - a[3], g)), (b[0] += (a[3] - a[1]) / 2)),
          null !== e[1]
            ? (n = Math.max(Math.min(n, b[2] - Math.max(a[0], a[2])), g))
            : ((n = Math.max(Math.min(n, b[2] - a[0] - a[2]), g)), (b[1] += (a[0] - a[2]) / 2)),
          n < b[2]
            ? ((b[2] = n),
              (b[3] = Math.min(p(d.innerSize || 0, n), n)),
              this.translate(b),
    ...
    e.column &&
      (e.column.prototype.alignDataLabel = function (a, c, e, g, f) {
        ...
        d.prototype.alignDataLabel.call(this, a, c, e, g, f);
        a.isLabelJustified &&
          a.contrastColor &&
          a.dataLabel.css({
  ...
  (function (a) {
    ...
    E.prototype.hideOverlappingLabels = function (a) {
      ...
      y = function (a) {
        ...
        if (a && (!a.alignAttr || a.placed))
          return (
            ...
            (c = a.parentGroup),
            a.width ||
              ((d = a.getBBox()), (a.width = d.width), (a.height = d.height), (d = l.fontMetrics(null, a.element).h)),
            {
      ...
      for (r = 0; r < f; r++) if ((q = a[r])) (q.oldOpacity = q.opacity), (q.newOpacity = 1), (q.absoluteBox = y(q));
      a.sort(function (a, b) {
      ...
      for (r = 0; r < f; r++)
        for (e = (y = a[r]) && y.absoluteBox, q = r + 1; q < f; ++q)
          if (
            ((d = (p = a[q]) && p.absoluteBox),
            e &&
              d &&
              y !== p &&
              0 !== y.newOpacity &&
              0 !== p.newOpacity &&
              (d = g(e.x, e.y, e.width, e.height, d.x, d.y, d.width, d.height)))
          )
  ...
  (function (a) {
    ...
    t = a.TrackerMixin = {
      ...
      drawTrackerGraph: function () {
        ...
        if (e && !c)
          for (l = e + 1; l--; )
            "M" === d[l] && d.splice(l + 1, 0, d[l + 1] - w, d[l + 2], "L"),
              ((l && "M" === d[l]) || l === e) && d.splice(l, 0, "L", d[l - 2] + w, d[l - 1]);
        k
          ? k.attr({
              d: d,
            })
      ...
      pan: function (a, b) {
        ...
        u("xy" === b ? [1, 0] : [1], function (b) {
          ...
          var d = b.horiz,
            ...
            g = l ? n : m,
            m = l ? m : n,
            n = Math.min(f.dataMin, k ? f.min : b.toValue(b.toPixels(f.min) - b.minPixelPadding)),
            ...
            b ||
              u(e.getSelectedPoints(), function (a) {
                a.selected &&
                  ...
                  (d.options.data[p(a, d.data)] = a.options),
                  a.setState(""),
        ...
        if (
          ...
          if (this.graphic)
            this.state && this.graphic.removeClass("highcharts-point-" + this.state),
              ...
              this.graphic.animate(e.pointAttribs(this, a), m(x.options.chart.animation, g.animation)),
              B && this.graphic.animate(B, m(x.options.chart.animation, l.animation, n.animation)),
              p && p.hide();
          else {
            if (a && l) {
              n = t.symbol || e.symbol;
              ...
              if (p)
                ...
                n &&
                  ((e.stateMarkerGraphic = p = x.renderer.symbol(n, B.x, B.y, B.width, B.height).add(e.markerGroup)),
                  (p.currentSymbol = n));
          ...
          (c = g.halo) && c.size
            ? (q || (e.halo = q = x.renderer.path().add((this.graphic || p).parentGroup)),
              q.show()[b ? "animate" : "attr"]({
        ...
        if (
          ...
          for (
            g = {
              ...
              d.animate(g, m(e[a || "normal"] && e[a || "normal"].animation, b.chart.options.chart.animation));
            b["zone-graph-" + c];
  ...
  (function (a) {
      ...
      l &&
        ...
        F(
          ...
          function (d) {
            ...
            this.matchResponsiveRule(d, q, f);
          },
          this,
        );
      var d = a.merge.apply(
    ...
    E.prototype.matchResponsiveRule = function (a, l) {
      ...
      (
        ...
        function () {
          return (
            this.chartWidth <= f(q.maxWidth, Number.MAX_VALUE) &&
            this.chartHeight <= f(q.maxHeight, Number.MAX_VALUE) &&
            this.chartWidth >= f(q.minWidth, 0) &&
            this.chartHeight >= f(q.minHeight, 0)
          );
        }
      ...
      function r(f, d, e, g) {
        ...
        a.objectEach(f, function (a, c) {
          if (!g && -1 < G(c, ["series", "xAxis", "yAxis"]))
            for (a = u(a), e[c] = [], m = 0; m < a.length; m++)
              d[c][m] && ((e[c][m] = {}), r(a[m], d[c][m], e[c][m], g + 1));
  ...
  (function (a) {
    ...
    p(F.prototype, "getTimeTicks", function (a, e, g, f, b, c, p, q) {
      var d = 0,
        ...
        k = this.chart.time;
      if ((!this.options.ordinal && !this.options.breaks) || !c || 3 > c.length || void 0 === g)
        return a.call(this, e, g, f, b);
      h = c.length;
      for (n = 0; n < h; n++) {
        B = n && c[n - 1] > f;
        c[n] < g && (d = n);
      ...
      if (q && a.unitRange <= y.hour) {
        n = u.length - 1;
        for (d = 1; d < n; d++)
          k.dateFormat("%d", u[d]) !== k.dateFormat("%d", u[d - 1]) && ((x[u[d]] = "day"), (r = !0));
        r && (x[u[0]] = "day");
        a.higherRanks = x;
      }
      u.info = a;
      if (q && l(w)) {
        ...
        n = [];
        var A;
        for (r = []; q--; ) (d = this.translate(u[q])), A && (r[q] = A - d), (n[q] = A = d);
        r.sort();
        ...
        for (A = void 0; q--; )
          (d = n[q]),
            (f = Math.abs(A - d)),
            A && f < 0.8 * w && (null === r || f < 0.8 * r)
              ? (x[u[q]] && !x[u[q + 1]] ? ((f = q + 1), (A = d)) : (f = q), u.splice(f, 1))
              : (A = d);
      }
      return u;
    });
    u(F.prototype, {
      beforeSetTickPositions: function () {
        ...
        !this.options.overscroll ||
          ...
          (this.chart.mouseIsDown && !b) ||
          (this.eventArgs && (!this.eventArgs || "navigator" === this.eventArgs.trigger)) ||
          ((this.max += this.options.overscroll), !b && l(this.userMin) && (this.min += this.options.overscroll));
        if (c || n) {
          f(this.series, function (b, c) {
            g = [];
            if (
              !((z && !1 === b.visible) || (!1 === b.takeOrdinalPosition && !n)) &&
              ((e = e.concat(b.processedXData)),
              (a = e.length),
              e.sort(function (a, b) {
                return a - b;
              }),
              (u = Math.min(u, r(b.closestPointRange, u))),
              a)
            ) {
              for (c = 0; c < a - 1; ) e[c] !== e[c + 1] && g.push(e[c + 1]), c++;
          ...
          if (2 < a) {
            ...
            this.options.overscroll &&
              (2 === a
                ? (u = e[1] - e[0])
                : 1 === a
                ? ((u = this.options.overscroll), (e = [e[0], e[0] + u]))
                : (u = this.overscrollPointsRange));
          m
            ? (this.options.overscroll &&
                ((this.overscrollPointsRange = u), (e = e.concat(this.getOverscrollPositions()))),
              (this.ordinalPositions = e),
              (b = this.ordinal2lin(Math.max(p, e[0]), !0)),
              (t = Math.max(this.ordinal2lin(Math.min(q, e[e.length - 1]), !0), 1)),
              (this.ordinalSlope = q = (q - p) / (t - b)),
              (this.ordinalOffset = p - b * q))
            : ((this.overscrollPointsRange = r(this.closestPointRange, this.overscrollPointsRange)),
      ...
      getExtendedPositions: function () {
        ...
        m[b] ||
          ...
          a.beforeSetTickPositions.apply(p),
          (m[b] = p.ordinalPositions));
        return m[b];
      },
      getOverscrollPositions: function () {
        var d = this.options.overscroll,
          ...
          g = [],
          f = this.dataMax;
        if (a.defined(e)) for (g.push(f); f <= this.dataMax + d; ) (f += e), g.push(f);
        return g;
      },
      ...
      if (d.options.ordinal && d.series.length) {
        ...
        h.ordinalPositions
          ? 1 < Math.abs(l) &&
            ...
            0 > l ? ((z = h), (y = d.ordinalPositions ? d : h)) : ((z = d.ordinalPositions ? d : h), (y = h)),
            (h = y.ordinalPositions),
            t > h[h.length - 1] && h.push(t),
            (this.fixedRange = r - n),
            (l = d.toFixedRange(
              null,
              null,
              D.apply(z, [u.apply(z, [n, !0]) + l, !0]),
              D.apply(y, [u.apply(y, [r, !0]) + l, !0]),
            )),
            l.min >= Math.min(p.dataMin, n) &&
              l.max <= Math.max(t, r) + m &&
              d.setExtremes(l.min, l.max, !0, !1, {
                trigger: "pan",
              }),
            (this.mouseDownX = b),
            q(this.container, {
  ...
  (function (a) {
    ...
    G(y, "afterSetTickPositions", function () {
      if (this.options.breaks) {
        var a = this.tickPositions,
          ...
          g = [],
          f;
        for (f = 0; f < a.length; f++) this.isInAnyBreak(a[f]) || g.push(a[f]);
    ...
    G(y, "afterInit", function () {
      ...
      a.isBroken &&
        ...
        (a.lin2val = function (d) {
          var e, b;
          for (b = 0; b < a.breakArray.length && !((e = a.breakArray[b]), e.from >= d); b++)
            e.to < d ? (d += e.len) : a.isInBreak(e, d) && (d += e.len);
          return d;
        }),
        ...
        (a.setAxisTranslation = function (d) {
          ...
          a.options.staticScale
            ? (a.transA = a.options.staticScale)
            : a.unitLength && (a.transA *= (n - a.min + u) / a.unitLength);
      ...
      if (d && f && (d.options.breaks || f.options.breaks))
        for (; c--; )
          (b = m[c]),
            (p = null === b.y && !1 === l),
            p ||
              (!d.isInAnyBreak(b.x, !0) && !f.isInAnyBreak(b.y, !0)) ||
              (m.splice(c, 1), this.data[c] && this.data[c].destroyElements());
    });
        ...
        f(e, function (e) {
          ...
          f(m, function (d) {
            ...
            f(b, function (b) {
              ...
              else if ((c < b.from && p > b.from && p < b.to) || (c > b.from && p > b.to && p < b.from))
                l = "pointInBreak";
              l &&
                r(a, l, {
                  point: d,
    ...
    a.Series.prototype.gappedPath = function () {
      var d = this.currentDataGrouping,
        ...
        b = this.yAxis;
      if (d && 0 < l)
        for ("value" !== this.options.gapUnit && (d *= this.closestPointRange), e && e > d && (d = e); l--; )
          f[l + 1].x - f[l].x > d &&
            ((e = (f[l].x + f[l + 1].x) / 2),
            f.splice(l + 1, 0, {
              isNull: !0,
            ...
            this.options.stacking &&
              ((e = b.stacks[this.stackKey][e] = new a.StackItem(b, b.options.stackLabels, !1, e, this.stack)),
              (e.total = 0)));
      return this.getGraphPath(f);
    };
    l(a.seriesTypes.column.prototype, "drawPoints", F);
    l(a.Series.prototype, "drawPoints", F);
  })(J);
  (function (a) {
    var E = a.addEvent,
      F = a.arrayMax,
    ...
    c.groupData = function (a, b, c, d) {
      ...
      for (I; I <= p; I++) {
        for (; (void 0 !== c[E + 1] && a[I] >= c[E + 1]) || I === p; ) {
          ...
          r = d.apply(e, D);
          f(e.dataGroupInfo.options) ||
            ((e.dataGroupInfo.options = e.pointClass.prototype.optionsToObject.call(
              {
                series: e,
              },
              e.options.data[L],
    ...
    c.processData = function () {
      ...
      if (!1 !== x.apply(this, arguments) && e) {
        ...
        var m,
          p = b.groupAll ? this.xData : this.processedXData,
        ...
        if (z) {
          ...
          z = ((z * (e - k)) / q) * r;
          q = a.getTimeTicks(
            a.normalizeTimeTickInterval(z, b.units || L),
            Math.min(k, p[0]),
            Math.max(e, p[p.length - 1]),
          ...
          if (b.smoothed && p.length) {
            m = p.length - 1;
            for (p[m] = Math.min(p[m], e); m-- && 0 < m; ) p[m] += z / 2;
            p[0] = Math.max(p[0], k);
          }
          k = q.info;
    ...
    b(m.prototype, "tooltipFooterHeaderFormatter", function (a, b, c) {
      var d = this.chart.time,
        ...
        h,
        n = e.xAxis;
      return n && "datetime" === n.options.type && k && y(b.key)
        ? ((a = e.currentDataGrouping),
          (k = k.dateTimeLabelFormats),
          a
            ? ((n = k[a.unitName]), 1 === a.count ? (g = n[0]) : ((g = n[1]), (h = n[2])))
            : !g && k && (g = this.getXDateFormat(b, f, n)),
          (g = d.dateFormat(g, b.key)),
          h && (g += d.dateFormat(h, b.key + a.totalRange - 1)),
          r(
            f[(c ? "footer" : "header") + "Format"],
            {
              point: C(b.point, {
                key: g,
              }),
    ...
    G(
      ...
      },
      {
        ...
        pointAttribs: function (a, f) {
          ...
          var l = this.options;
          delete f.fill;
          !a.options.color && l.upColor && a.open < a.close && (f.stroke = l.upColor);
          return f;
        },
        translate: function () {
          var a = this,
        ...
        drawPoints: function () {
          ...
          E(a.points, function (l) {
            var q,
              ...
              g = !d;
            void 0 !== l.plotY &&
              (d || (l.graphic = d = f.renderer.path().add(a.group)),
              d.attr(a.pointAttribs(l, l.selected && "select")),
              (r = (d.strokeWidth() % 2) / 2),
              (e = Math.round(l.plotX) - r),
              (u = Math.round(l.shapeArgs.width / 2)),
              (p = ["M", e, Math.round(l.yBottom), "L", e, Math.round(l.plotHigh)]),
              null !== l.open && ((q = Math.round(l.plotOpen) + r), p.push("M", e, q, "L", e - u, q)),
              null !== l.close && ((q = Math.round(l.plotClose) + r), p.push("M", e, q, "L", e + u, q)),
              d[g ? "attr" : "animate"]({
                d: p,
      ...
      },
      {
        getClassName: function () {
          return (
            F.prototype.getClassName.call(this) +
    ...
    q(
      ...
      }),
      {
        pointAttribs: function (a, q) {
          ...
          q &&
            ((a = r.states[q]),
            (f.fill = a.color || f.fill),
            (f.stroke = a.lineColor || f.stroke),
        ...
        drawPoints: function () {
          ...
          F(a.points, function (f) {
            var r = f.graphic,
              ...
              x = !r;
            void 0 !== f.plotY &&
              (r || (f.graphic = r = l.renderer.path().add(a.group)),
              r.attr(a.pointAttribs(f, f.selected && "select")).shadow(a.options.shadow),
              (m = (r.strokeWidth() % 2) / 2),
              (b = Math.round(f.plotX) - m),
              (p = f.plotOpen),
              (d = f.plotClose),
              (e = Math.min(p, d)),
              (p = Math.max(p, d)),
              (c = Math.round(f.shapeArgs.width / 2)),
              (d = q ? p !== f.yBottom : Math.round(e) !== Math.round(f.plotHigh)),
              (g = q ? Math.round(e) !== Math.round(f.plotHigh) : p !== f.yBottom),
              (e = Math.round(e) + m),
              (p = Math.round(p) + m),
              (m = []),
              m.push(
                ...
                "L",
                b,
                d ? Math.round(q ? f.yBottom : f.plotHigh) : e,
                "M",
                b,
                p,
                "L",
                b,
                g ? Math.round(q ? f.plotHigh : f.yBottom) : p,
              ),
              r[x ? "attr" : "animate"]({
                d: m,
  ...
  ea = (function (a) {
    ...
    return {
      ...
      translate: function () {
        ...
        if (p && p.visible && g)
          for (
            x = (p.pointXOffset || 0) + (p.barW || 0) / 2,
              r = p.currentDataGrouping,
              t = e[g - 1].x + (r ? r.totalRange : 0),
              q(u, function (a, b) {
                return a.x - b.x;
              }),
            ...
            B.x <= r.x &&
              ...
              (r.x <= t &&
                ...
                B.x < r.x &&
                  ...
                  (n = e[g + 1]) &&
                  void 0 !== n[a] &&
                  ((L = (r.x - B.x) / (n.x - B.x)), (r.plotY += L * (n[a] - B[a])), (r.y += L * (n.y - B.y)))),
              C--,
              g++,
              0 > C));
        ...
        E(u, function (a, d) {
          ...
          a.plotX += x;
          if (void 0 === a.plotY || m)
            0 <= a.plotX && a.plotX <= b.len
              ? m
                ? ((a.plotY = b.translate(a.x, 0, 1, 0, 1)), (a.plotX = F(a.y) ? c.translate(a.y, 0, 0, 0, 1) : 0))
                : (a.plotY = f.chartHeight - b.bottom - (b.opposite ? b.height : 0) + b.offset - c.top)
              : (a.shapeArgs = {});
          (y = u[d - 1]) &&
            y.plotX === a.plotX &&
  ...
  (function (a, E) {
    function F(a) {
      d[a + "pin"] = function (e, f, b, c, l) {
        ...
        g &&
          l &&
          (e.push("M", "circle" === a ? e[1] - e[4] : e[1] + e[4] / 2, f > l ? f : f + c, "L", g, l),
          (e = e.concat(d.circle(g - 1, l - 1, 2, 2))));
        return e;
      };
    }
    var G = a.addEvent,
    ...
    r(
      ...
      },
      {
        ...
        drawPoints: function () {
          ...
          for (u = d.length; u--; )
            (z = d[u]),
              (y = (p ? z.plotY : z.plotX) > this.xAxis.len),
              (b = z.plotX),
              (D = z.stackIndex),
              (n = z.options.shape || r.shape),
              (c = z.plotY),
              void 0 !== c && (c = z.plotY + t - (void 0 !== D && D * r.stackDistance)),
              (z.anchorX = D ? void 0 : z.plotX),
              (h = D ? void 0 : z.plotY),
              (D = z.graphic),
              void 0 !== c && 0 <= b && !y
                ? (D ||
                    ((D = z.graphic =
                      m
                        .label("", null, null, n, null, null, r.useHTML)
                        .attr(this.pointAttribs(z))
                        .css(l(r.style, z.style))
                        .attr({
                    ...
                    z.graphic.div && (z.graphic.div.point = z),
                    D.shadow(r.shadow),
                    (D.isNew = !0)),
                  0 < b && (b -= D.strokeWidth() % 2),
                  (n = {
                    y: c,
                    anchorY: h,
                  }),
                  r.allowOverlapX && ((n.x = b), (n.anchorX = z.anchorX)),
                  D.attr({
                    text: z.options.title || r.title || "A",
                  })[D.isNew ? "attr" : "animate"](n),
                  r.allowOverlapX ||
                    (v[z.plotX]
                      ? (v[z.plotX].size = Math.max(v[z.plotX].size, D.width))
                      : (v[z.plotX] = {
                          align: 0,
                          size: D.width,
                          target: b,
                  ...
                  (z.tooltipPos = [b, c + C.pos - f.plotTop]))
                : D && (z.graphic = D.destroy());
          r.allowOverlapX ||
            (a.objectEach(v, function (a) {
              a.plotX = a.anchorX;
              w.push(a);
            }),
            a.distribute(w, p ? C.len : this.xAxis.len, 100),
            q(d, function (a) {
        ...
        drawTracker: function () {
          ...
          q(a, function (d) {
            var e = d.graphic;
            e &&
              G(e.element, "mouseover", function () {
                0 < d.stackIndex &&
                  !d.raised &&
                  ((d._y = e.y),
                  e.attr({
    ...
    d.flag = function (a, f, l, b, c) {
      ...
      return d
        .circle(e - 1, c - 1, 2, 2)
        .concat(["M", e, c, "L", a, f + b, a, f, a + l, f, a + l, f + b, a, f + b, "Z"]);
    };
    F("circle");
    F("square");
    u === p &&
      q(["flag", "circlepin", "squarepin"], function (a) {
  ...
  (function (a) {
    ...
    E.prototype = {
      ...
      position: function (a, c, d, e) {
        ...
        b
          ...
          : ((this.height = this.xOffset = e = c = this.size),
            (this.barWidth = d - 2 * e),
      ...
      setRange: function (a, c) {
        ...
        f(g) &&
          ((a = Math.max(a, 0)),
          (l = Math.ceil(g * a)),
          (this.calculatedWidth = m = q(g * Math.min(c, 1) - l)),
          m < e && ((l = (g - e + m) * a), (m = e)),
          (e = Math.floor(l + this.xOffset + this.yOffset)),
          (g = m / 2 - 0.5),
          (this.from = a),
          (this.to = c),
          d
            ? (this.scrollbarGroup[p]({
                translateY: e,
              }),
              this.scrollbar[p]({
                height: m,
      ...
      initEvents: function () {
        ...
        a.mouseMoveHandler = function (b) {
          ...
          !a.grabbedCenter ||
            ...
            ((c = a.cursorToScrollbarPosition(c)[d]),
            (d = a[d]),
            (d = c - d),
            (a.hasDragged = !0),
        ...
        a.trackClick = function (b) {
          ...
          (a.options.vertical && c.chartY > e) || (!a.options.vertical && c.chartX > f)
    ...
    F(G, "afterInit", function () {
      ...
      a.options.scrollbar &&
        ...
        (a.scrollbar = new E(a.chart.renderer, a.options.scrollbar, a.chart)),
        F(a.scrollbar, "changed", function (b) {
          ...
          (a.horiz && !a.reversed) || (!a.horiz && a.reversed)
            ? ((f = c + e * this.to), (c += e * this.from))
            : ((f = c + e * (1 - this.from)), (c += e * (1 - this.to)));
    ...
    F(G, "afterRender", function () {
      ...
      if (e) {
        this.horiz
          ? (e.position(
              ...
              this.top +
                ...
                (this.opposite ? 0 : g + this.axisTitleMargin + this.offset),
              this.width,
              this.height,
            ),
            (g = 1))
          : (e.position(
              this.left +
                ...
                (this.opposite ? g + this.axisTitleMargin + this.offset : 0),
              this.top,
              this.width,
              this.height,
            ),
        ...
        if ((!this.opposite && !this.horiz) || (this.opposite && this.horiz))
          this.chart.scrollbarsOffsets[g] += this.scrollbar.size + this.scrollbar.options.margin;
        isNaN(a) || isNaN(c) || !f(this.min) || !f(this.max)
          ? e.setRange(0, 0)
          : ((g = (this.min - a) / (c - a)),
            (a = (this.max - a) / (c - a)),
    ...
    F(G, "afterGetOffset", function () {
      var a = this.horiz ? 2 : 1,
        c = this.scrollbar;
      c && ((this.chart.scrollbarsOffsets = [0, 0]), (this.chart.axisOffset[a] += c.size + c.options.margin));
    });
    a.Scrollbar = E;
  })(J);
  (function (a) {
    ...
    d(f, {
      navigator: {
        ...
        maskFill: l("#6685c2").setOpacity(0.3).get(),
        outlineColor: "#cccccc",
        outlineWidth: 1,
        series: {
          type: D,
    ...
    E.prototype = {
        ...
        c
          ? ((l -= f),
            ...
            (a = [
              ...
              l + g,
              m + n + h,
            ].concat(e ? ["M", l + g, c - f, "L", l + g, b + f] : [])))
          : ((a += l + h - k),
            (b += l + h - k),
            (m += f),
            (a = ["M", l, m, "L", a, m, "L", a, m + g, "L", b, m + g, "L", b, m, "L", l + n + 2 * h, m].concat(
              e ? ["M", a - f, m, "L", b + f, m] : [],
            )));
        this.outline[d]({
          d: a,
      ...
      drawMasks: function (a, b, c, d) {
        var e = this.left,
          ...
          l;
        c
          ? ((n = [e, e, e]), (l = [k, k + a, k + b]), (h = [f, f, f]), (g = [a, b - a, this.size - b]))
          : ((n = [e, e + a, e + b]), (l = [k, k, k]), (h = [a, b - a, this.size - b]), (g = [f, f, f]));
      ...
      render: function (c, d, e, f) {
        ...
        if (!this.hasDragged || u(e)) {
          ...
          q < r
            ? this.grabbedLeft
              ? (e = m.toPixels(d - r, !0))
              : this.grabbedRight && (f = m.toPixels(c + r, !0))
            : u(z) &&
              q > z &&
              (this.grabbedLeft ? (e = m.toPixels(d - z, !0)) : this.grabbedRight && (f = m.toPixels(c + z, !0)));
          this.zoomedMax = Math.min(Math.max(e, f, 0), v);
          this.zoomedMin = Math.min(
            Math.max(this.fixedWidth ? this.zoomedMax - this.fixedWidth : Math.min(e, f), 0),
            v,
          );
          ...
          p &&
            ...
            this.drawMasks(e, v, h, w),
            this.drawOutline(e, v, h, w),
            this.navigatorOptions.handles.enabled && (this.drawHandle(e, 0, h, w), this.drawHandle(v, 1, h, w)));
          this.scrollbar &&
            (h
              ? ((h = this.top - n),
                (g = this.left - n + (p || !g.opposite ? 0 : (g.titleOffset || 0) + g.axisTitleMargin)),
                (n = l + 2 * n))
              : ((h = this.top + (p ? this.height : -n)), (g = this.left - n)),
            this.scrollbar.position(g, h, k, n),
      ...
      addMouseEvents: function () {
        ...
        g &&
          (d.push(F(c, "touchmove", e), F(c.ownerDocument, "touchend", f)), d.concat(a.getPartsEvents("touchstart")));
        a.eventsToUnbind = d;
        a.series &&
          a.series[0] &&
          d.push(
            F(a.series[0].xAxis, "foundExtremes", function () {
      ...
      shadesMousedown: function (a, b) {
        ...
        1 === b
          ? ((this.grabbedCenter = n), (this.fixedWidth = h), (this.dragOffset = n - e))
          : ((a = n - f - h / 2),
            0 === b
              ? (a = Math.max(0, a))
              : 2 === b &&
      ...
      onMouseMove: function (b) {
        ...
        (b.touches && 0 === b.touches[0].pageX) ||
          ...
          c.hasDragged &&
            c.scrollbar &&
            t(c.scrollbar.options.liveRedraw, a.svg && !x && !this.chart.isBoosting) &&
            ((b.DOMType = b.type),
            setTimeout(function () {
              c.onMouseUp(b);
            }, 0)));
      ...
      removeEvents: function () {
        this.eventsToUnbind &&
          (r(this.eventsToUnbind, function (a) {
            a();
          }),
      ...
      init: function (a) {
        ...
        h.navigatorEnabled
          ? ((h.xAxis = new G(
            ...
            d || c.series.data
              ...
              : 0 === a.series.length &&
                (h.unbindRedraw = F(a, "beforeRedraw", function () {
        ...
        a.options.scrollbar.enabled &&
          ...
          F(h.scrollbar, "changed", function (b) {
            var c = h.size,
              d = c * this.to,
              c = c * this.from;
      ...
      getUnionExtremes: function (a) {
        ...
        (a && null === b.dataMin) ||
          (f = {
            dataMin: t(d && d.min, H("min", e.min, b.dataMin, c.dataMin, c.min)),
      ...
      setBaseSeries: function (a, b) {
        ...
        r(c.series || [], function (b, c) {
          b.options.isInternal ||
            (!b.options.showInNavigator && ((c !== a && b.options.id !== a) || !1 === b.options.showInNavigator)) ||
            d.push(b);
        });
        ...
        var e = this,
          ...
          w = (e.series = a.grep(e.series || [], function (b) {
            ...
            return 0 > a.inArray(c, h)
              ? (c && (n(c, "updatedData", e.updatedDataHandler), delete c.navigatorSeries), b.chart && b.destroy(), !1)
              : !0;
          }));
        h &&
          h.length &&
          r(h, function (a) {
            var b = a.navigatorSeries,
              k = d(
                ...
                m(v) ? f.navigator.series : v,
              );
            (b && !1 === e.navigatorOptions.adaptToUpdatedData) ||
              ((q.name = "Navigator " + h.length),
              (l = a.options || {}),
              (t = l.navigatorOptions || {}),
              (p = B(l, q, k, t)),
              (k = t.data || k.data),
              (e.hasNavigatorData = e.hasNavigatorData || !!k),
              (p.data = k || (l.data && l.data.slice(0))),
              b && b.options
                ? b.update(p, c)
                : ((a.navigatorSeries = g.initSeries(p)),
                  (a.navigatorSeries.baseSeries = a),
                  w.push(a.navigatorSeries)));
          });
        if ((v.data && (!h || !h.length)) || m(v))
          (e.hasNavigatorData = !1),
            ...
            r(v, function (a, b) {
              ...
              p = B(
                ...
                {
                  color:
                    (g.series[b] && !g.series[b].options.isInternal && g.series[b].color) ||
                    g.options.colors[b] ||
                    g.options.colors[0],
                },
                q,
      ...
      modifyBaseAxisExtremes: function () {
        ...
        (this.eventArgs && "rangeSelectorButton" === this.eventArgs.trigger) ||
          (f && ((l = d), (n = l + c)),
          g && ((n = e + h), f || (l = Math.max(n - c, m && m.xData ? m.xData[0] : -Number.MAX_VALUE))),
          p && (f || g) && b(l) && ((this.min = this.userMin = l), (this.max = this.userMax = n)));
      ...
      updatedDataHandler: function () {
        ...
        a.stickToMin =
          b(this.xAxis.min) && this.xAxis.min <= this.xData[0] && (!this.chart.fixedRange || !a.stickToMax);
        c &&
          !a.hasNavigatorData &&
          ((c.options.pointStart = this.xData[0]), c.setData(this.options.data, !1, null, !1));
      },
    ...
    F(q, "afterSetChartSize", function () {
      ...
      b &&
        ...
        (c = b.scrollbarHeight),
        this.inverted
          ? ((b.left = b.opposite ? this.chartWidth - c - b.height : this.spacing[3] + c), (b.top = this.plotTop + c))
          : ((b.left = this.plotLeft + c),
            (b.top =
              ...
              this.chartHeight -
                ...
                (d && "bottom" === d.verticalAlign && d.enabled && !d.floating
                  ? a.legendHeight + t(d.margin, 10)
                  : 0))),
        e &&
          f &&
          (this.inverted ? (e.options.left = f.options.left = b.left) : (e.options.top = f.options.top = b.top),
          e.setAxisSize(),
          f.setAxisSize()));
    });
    F(q, "update", function (a) {
      ...
      this.navigator ||
        this.scroller ||
        (!b.enabled && !c.enabled) ||
        (B(!0, this.options.navigator, b),
        B(!0, this.options.scrollbar, c),
    ...
    h(z.prototype, "addPoint", function (a, b, d, e, f) {
  ...
  (function (a) {
    ...
    E.prototype = {
      clickButton: function (a, c) {
        var d = this,
          ...
          m = n.dataMax,
          t,
          k = h && Math.round(Math.min(h.max, b(m, h.max))),
          q = f.type,
          r,
          n = f._range,
          u,
        ...
        if (null !== l && null !== m) {
          ...
          if ("month" === q || "year" === q)
            h
              ? ((q = {
                ...
                (t = h.minFromRange.call(q)),
                g(q.newMax) && (k = q.newMax))
              : (n = f);
            ...
            if (h)
              void 0 === m &&
                ...
                (c = !1)),
                (k = d.getYTDExtremes(m, l, e.time.useUTC)),
                (t = u = k.min),
                (k = k.max);
            else {
          ...
          d.setSelected(a);
          h
            ? h.setExtremes(t, k, b(c, 1), null, {
                trigger: "rangeSelectorButton",
                rangeSelectorButton: f,
              })
            : ((r = x(e.options.xAxis)[0]),
              (B = r.range),
              (r.range = n),
              (y = r.min),
              (r.min = u),
      ...
      init: function (a) {
        ...
        F(a, "load", function () {
          a.xAxis &&
            a.xAxis[0] &&
            F(a.xAxis[0], "setExtremes", function (c) {
      ...
      updateButtonStates: function () {
        ...
        p(a.buttonOptions, function (b, f) {
          ...
          d - 36e5 <=
            ...
            : "ytd" === h
            ? ((g = r - q + b === d), (z = !f))
            : "all" === h && ((g = c.max - c.min >= m - l), (A = !f && u && g));
          h = !x && (v || w || A || e);
      ...
      drawInput: function (a) {
        function b() {
          ...
          b !== w.previousValue &&
            ((w.previousValue = b),
            g(b) || ((b = a.split("-")), (b = Date.UTC(c(b[0]), c(b[1]) - 1, c(b[2])))),
            g(b) &&
              (p.time.useUTC || (b += 6e4 * new Date().getTimezoneOffset()),
              v
                ? b > e.maxInput.HCTime
                  ? (b = void 0)
                  : b < k && (b = k)
                ...
                : b > f && (b = f),
              void 0 !== b &&
                d.setExtremes(v ? b : d.min, v ? d.max : b, void 0, void 0, {
      ...
      render: function (a, c) {
        ...
        if (!1 !== k.enabled) {
          X ||
            ((d.group = X =
              g
                ...
                .add()),
            (d.buttonGroup = J = g.g("range-selector-buttons").add(X)),
            (d.zoomText = g.text(m.rangeSelectorZoom, 0, 15).css(k.labelStyle).add(J)),
            p(d.buttonOptions, function (a, b) {
              r[b] = g
                .button(
                  a.text,
                  0,
            ...
            !1 !== C &&
              ...
              (d.inputGroup = q = g.g("input-group").add(X)),
              (q.offset = 0),
              d.drawInput("min"),
              d.drawInput("max")));
          d.zoomText[fa]({
          ...
          p(d.buttonOptions, function (a, c) {
            ...
            G += r[c].width + b(k.buttonSpacing, 5);
          });
          F = e.plotLeft - e.spacing[3];
          d.updateButtonStates();
          n &&
            this.titleCollision(e) &&
            "top" === Y &&
            "right" === y.align &&
            y.y + J.getBBox().height - 12 < (n.y || 0) + n.height &&
            (V = -40);
          ...
          !1 !== C &&
            ((V =
              ...
              "top" === Y &&
              "right" === B.align &&
              B.y - q.getBBox().height - 12 < (n.y || 0) + n.height + e.spacing[0]
                ? -40
                : 0),
            "left" === B.align ? (P = F) : "right" === B.align && (P = -Math.max(e.axisOffset[1], -V)),
            q.align(
              {
                y: B.y,
            ...
            (h = q.alignAttr.translateX + q.alignOptions.x - V + q.getBBox().x + 2),
            (n = q.alignOptions.width),
            (m = J.alignAttr.translateX + J.getBBox().x),
            (P = J.getBBox().width + 20),
            (B.align === y.align || (m + P > h && h + n > m && ca < Z + q.getBBox().height)) &&
              q.attr({
            ...
            d.setInputValue("max", c),
            (d.inputGroup.placed = da));
          d.group.align(
            {
              verticalAlign: Y,
            },
          ...
          "bottom" === Y &&
            ((aa =
              ba && "bottom" === ba.verticalAlign && ba.enabled && !ba.floating
                ? aa.legendHeight + b(ba.margin, 10)
                : 0),
            (a = a + aa - 20),
            (U = c - a - (l ? 0 : k.y) - 10));
          if ("top" === Y)
          ...
          d.group.translate(k.x, k.y + Math.floor(U));
          !1 !== C &&
    ...
    G.prototype.minFromRange = function () {
      ...
      g(d) || (d = f);
      d <= f && ((d = f), void 0 === h && (h = l(d, a.count)), (this.newMax = Math.min(d + h, this.dataMax)));
      g(e) || (d = void 0);
      return d;
    };
    ...
    F(q, "update", function (a) {
      ...
      a &&
        ...
        this.extraBottomMargin !== c || this.extraTopMargin !== d) &&
        (this.isDirtyBox = !0);
    });
    ...
    q.prototype.callbacks.push(function (a) {
      ...
      var c,
        ...
        f;
      d &&
        ((f = F(a.xAxis[0], "afterSetExtremes", function (a) {
  ...
  (function (a) {
    ...
    a.StockChart = a.stockChart = function (c, d, f) {
      ...
      h.yAxis = g(t(h.yAxis || {}), function (a, c) {
        q = b(a.opposite, !0);
        return m(
          {
            labels: {
    ...
    z(q.prototype, "autoLabelAlign", function (a) {
      ...
      return this.chart.options.isStock && "yAxis" === this.coll && ((c = c.top + "," + c.height), !b[c] && d.enabled)
        ? (15 === d.x && (d.x = 0), void 0 === d.align && (d.align = "right"), (b[c] = this), "right")
      ...
      d(F) &&
        (q.horiz
          ? u(E, function (a) {
              ...
              if (y < w || y > w + q.width) m ? (y = z = Math.min(Math.max(w, y), w + q.width)) : (b = !0);
    ...
    E(q, "afterDrawCrosshair", function (a) {
      ...
      if (f(this.crosshair.label) && this.crosshair.label.enabled && this.cross) {
        ...
        h
          ? ((a = v ? x.plotX + d : u.chartX), (l += c ? 0 : this.height))
          : ((a = c ? this.width + d : 0), (l = v ? x.plotY + l : u.chartY));
        ...
        h
          ? ((c = d - g.x), (d = d + this.width - g.x))
          : ((c = "left" === this.labelAlign ? d : 0),
            (d = "right" === this.labelAlign ? d + this.width : e.chartWidth));
      ...
      if (this.xAxis && this.processedYData)
        for (
          c = this.processedXData,
            ...
            g = e.length,
            this.pointArrayMap &&
              ((b = p("close", this.pointArrayMap)), -1 === b && (b = p(this.pointValKey || "y", this.pointArrayMap))),
            a = 0;
          a < g - f;
          a++
        )
    ...
    z(B.prototype, "render", function (a) {
      ...
      (this.chart.is3d && this.chart.is3d()) ||
        ...
        !this.xAxis ||
        this.xAxis.isRadial ||
        ((b = this.yAxis.len - (this.xAxis.axisLine ? Math.floor(this.xAxis.axisLine.strokeWidth() / 2) : 0)),
        !this.clipBox && this.animate
          ? ((this.clipBox = m(this.chart.clipBox)), (this.clipBox.width = this.xAxis.len), (this.clipBox.height = b))
    ...
    E(l, "update", function (a) {
      ...
      "scrollbar" in a &&
        this.navigator &&
        (m(!0, this.options.scrollbar, a.scrollbar), this.navigator.update({}, !1), delete a.scrollbar);
    });
  })(J);
  return J;
});
