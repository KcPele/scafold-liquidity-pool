      ...
      parseDate: function (e, r) {
        ...
        for (a = e.replace(d.separators, "\x00").split("\x00"), u = 0; u < a.length; u++)
          switch (((i = a[u]), (s = parseInt(i)), n[u])) {
            ...
            case "h":
              if (
                ((c = n.indexOf("a") > -1 ? n.indexOf("a") : n.indexOf("A") > -1 ? n.indexOf("A") : -1),
                (h = a[c]),
                c > -1)
              )
...
var datetimepickerFactory = function ($) {
  ...
  $.fn.datetimepicker = function (opt, opt2) {
    var result = this,
      ...
      ctrlDown = false,
      options =
        $.isPlainObject(opt) || !opt ? $.extend(true, {}, default_options, opt) : $.extend(true, {}, default_options),
      lazyInitTimer = 0,
          ...
          if (!this.touchMoved) {
            ...
            if (_xdsoft_datetime && _xdsoft_datetime.currentTime) {
              _xdsoft_datetime.currentTime[
                $(this).parent().parent().hasClass("xdsoft_monthselect") ? "setMonth" : "setFullYear"
              ]($(this).data("value"));
            }
        ...
        .on("xchange.xdsoft", function (event) {
          ...
          xchangeTimer = setTimeout(function () {
            ...
            while (
              ...
              if (
                dateHelper.formatDate(today, options.formatDate) === dateHelper.formatDate(start, options.formatDate)
              ) {
            ...
            line_time = function line_time(h, m) {
              ...
              if (!isALlowTimesInit) {
                current_time.setMinutes(
                  Math[options.roundTime](_xdsoft_datetime.currentTime.getMinutes() / options.step) * options.step,
                );
              }
      ...
      function setMask(options) {
        var isValidValue = function (mask, value) {
          ...
          setCaretPos = function (node, pos) {
            node =
              typeof node === "string" || node instanceof String ? options.ownerDocument.getElementById(node) : node;
            if (!node) {
              return false;
            }
        ...
        if ($.type(opt) === "string") {
          switch (opt) {
            ...
            case "reset":
              ...
              if (
                !this.value ||
                !datetimepicker.data("xdsoft_datetime").isValidDate(dateHelper.parseDate(this.value, options.format))
              ) {
